...
ACMD(do_galikgun) {
    ...
    if (vict) {
        ...
        if (!tech_handle_zanzoken(ch, vict, "Galik Gun")) {
            ...
            pcost(vict, 0, (ch_getEffMaxPL(vict)) / 200);
            return;
        }

        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (tech_handle_android_absorb(ch, vict)) {
                    pcost(ch, 1, 0);
                    return;
                } else if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your Galik Gun!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Galik Gun!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Galik Gun!@n", false, ch, NULL, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_GALIKGUN) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W manages to dodge your Galik Gun, letting it slam into the surroundings!@n", false, ch,
                        NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Galik Gun, letting it slam into the surroundings!@n", false, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@C$n@W fires a Galik Gun at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a Galik Gun at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your Galik Gun misses, flying through the air harmlessly!@n", false, ch,
                    NULL, vict, TO_CHAR);
                act("@C$n@W fires a Galik Gun at you, but misses!@n", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a Galik Gun at @C$N@W, but somehow misses!@n", false, ch, NULL, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_GALIKGUN) == 3 && attperc > minimum) {
                    pcost(ch, attperc - 0.05, 0);
                } else {
                    pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 16, skill, attperc);
        dmg /= 10;
        act("@WYou fire a Galik Gun at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a Galik Gun at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
...
ACMD(do_honoo) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (tech_handle_android_absorb(ch, vict)) {
                    ...
                    act("@C$N@W moves quickly and blocks your honoo!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W honoo!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W honoo!@n", false, ch, NULL, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_HONOO) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your honoo, letting it slam into the surroundings!@n", false, ch,
                        NULL,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W honoo, letting it slam into the surroundings!@n", false, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your honoo misses, flying through the air harmlessly!@n", false, ch,
                        NULL, vict, TO_CHAR);
                    act("@C$n@W fires a honoo at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a honoo at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict, TO_NOTVICT);
        ...
        if (GET_OBJ_VNUM(obj) == 79)
            dmg *= 3;
        act("@WYou fire a honoo at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a honoo at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_psyblast) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (tech_handle_android_absorb(ch, vict)) {
                    ...
                    act("@C$N@W moves quickly and blocks your psychic blast!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W psychic blast!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W psychic blast!@n", false, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_PSYBLAST) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                    ...
                    act("@C$n@W fires a psychic blast at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a psychic blast at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
            ...
            if (!AFF_FLAGGED(vict, AFF_SHOCKED) && rand_number(1, 4) == 4 && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
                act("@MYour mind has been shocked!@n", true, vict, NULL, NULL, TO_CHAR);
                act("@M$n@m's mind has been shocked!@n", true, vict, NULL, NULL, TO_ROOM);
        ...
        dmg = damtype(ch, 20, skill, attperc);
        dmg /= 10;
        act("@WYou fire a psychic blast at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a psychic blast at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_tslash) {
    ...
    if (!HAS_ARMS(ch)) {
        ...
        if (GET_LIMBCOND(ch, 1) < 0) {
            act("@RYour right arm has fallen apart!@n", true, ch, NULL, NULL, TO_CHAR);
            act("@r$n@R's right arm has fallen apart!@n", true, ch, NULL, NULL, TO_ROOM);
        }
        ...
        if (GET_LIMBCOND(ch, 2) < 0) {
            act("@RYour left arm has fallen apart!@n", true, ch, NULL, NULL, TO_CHAR);
            act("@r$n@R's left arm has fallen apart!@n", true, ch, NULL, NULL, TO_ROOM);
        }
    }
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your twin slash!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W twin slash!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W twin slash!@n", false, ch, NULL, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_TSLASH) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your twin slash, letting it slam into the surroundings!@n", false, ch,
                        NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W twin slash, letting it slam into the surroundings!@n", false, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your twin slash misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a twin slash at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a twin slash at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your twin slash misses, flying through the air harmlessly!@n", false,
                    ch, NULL, vict, TO_CHAR);
                act("@C$n@W fires a twin slash at you, but misses!@n", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a twin slash at @C$N@W, but somehow misses!@n", false, ch, NULL, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_TSLASH) == 3 && attperc > minimum) {
                    pcost(ch, attperc - 0.05, 0);
                } else {
                    pcost(ch, attperc, 0);
            ...
            switch (hitspot) {
                case 1:
                    ...
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    if (ch_hasTail(vict)) {
                        act("@rYou cut off $S tail!@n", true, ch, NULL, vict, TO_CHAR);
                        act("@rYour tail is cut off!@n", true, ch, NULL, vict, TO_VICT);
                        act("@R$N@r's tail is cut off!@n", true, ch, NULL, vict, TO_NOTVICT);
                        ch_loseTail(vict);
                    }
                    break;
                case 2: /* Critical */
                    ...
                    act("@C$n @Wchannels $s charged ki into the blade of $s sword. @rF@Rl@Ya@rm@Ri@Yn@rg @gg@Gre@wen@W energy burns around the blade as $e draws it up to attack. Two blindingly quick slashes connect with @c$N@W's face as $e flies past, leaving a green after-image behind!@n",
                        true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    if (dmg > (ch_getEffMaxPL(vict)) / 5 && (!IS_MAJIN(vict) && !IS_BIO(vict))) {
                        act("@R$N@r has $S head cut off by the attack!@n", true, ch, NULL, vict, TO_CHAR);
                        act("@rYou have your head cut off by the attack!@n", true, ch, NULL, vict, TO_VICT);
                        act("@R$N@r has $S head cut off by the attack!@n", true, ch, NULL, vict, TO_NOTVICT);
                    ...
                    } else if (dmg > (ch_getEffMaxPL(vict)) / 5 && (IS_MAJIN(vict) || IS_BIO(vict))) {
                        if (GET_SKILL(vict, SKILL_REGENERATE) > rand_number(1, 101) &&
                            ((ch_getMaxKI(vict) * vict->energy)) >= GET_MAX_MANA(vict) / 40) {
                            ...
                            act("@R$N@r has $S head cut off by the attack but regenerates a moment later!@n", true, ch,
                                NULL, vict, TO_NOTVICT);
                            int64_t amt = ch_getMaxKI(vict) / 40;
                            int64_t result;
                            result = ch_decCurKI(vict, amt, 0);
                            hurt(0, 0, ch, vict, NULL, dmg, 1);
                        } else {
                            act("@R$N@r has $S head cut off by the attack!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@rYou have your head cut off by the attack!@n", true, ch, NULL, vict, TO_VICT);
                ...
                case 4: /* Weak */
                    ...
                    if (rand_number(1, 100) >= 70 && !IS_NPC(vict) && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
                        if (GET_LIMBCOND(vict, 2) > 0 && !is_sparring(ch) && rand_number(1, 2) == 2) {
                            act("@RYour attack severs $N's left arm!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@R$n's attack severs your left arm!@n", true, ch, NULL, vict, TO_VICT);
                            act("@R$N's left arm is severered in the attack!@n", true, ch, NULL, vict, TO_VICT);
                            GET_LIMBCOND(vict, 2) = 0;
                            remove_limb(vict, 2);
                        } else if (GET_LIMBCOND(vict, 1) > 0 && !is_sparring(ch)) {
                            act("@RYour attack severs $N's right arm!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@R$n's attack severs your right arm!@n", true, ch, NULL, vict, TO_VICT);
                            act("@R$N's right arm is severered in the attack!@n", true, ch, NULL, vict, TO_VICT);
                ...
                case 5: /* Weak 2 */
                    ...
                    if (rand_number(1, 100) >= 70 && !IS_NPC(vict) && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
                        if (GET_LIMBCOND(vict, 4) > 0 && !is_sparring(ch) && rand_number(1, 2) == 2) {
                            act("@RYour attack severs $N's left leg!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@R$n's attack severs your left leg!@n", true, ch, NULL, vict, TO_VICT);
                            act("@R$N's left leg is severered in the attack!@n", true, ch, NULL, vict, TO_VICT);
                            GET_LIMBCOND(vict, 4) = 0;
                            remove_limb(vict, 4);
                        } else if (GET_LIMBCOND(vict, 3) > 0 && !is_sparring(ch)) {
                            act("@RYour attack severs $N's right leg!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@R$n's attack severs your right leg!@n", true, ch, NULL, vict, TO_VICT);
                            act("@R$N's right leg is severered in the attack!@n", true, ch, NULL, vict, TO_VICT);
        ...
        dmg = damtype(ch, 19, skill, attperc);
        dmg /= 10;
        act("@WYou fire a twin slash at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a twin slash at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (!tech_handle_zanzoken(ch, vict, "Eraser Cannon")) {
            ...
            if (GET_SKILL(ch, SKILL_ERASER) >= 100) {
                int64_t amt = (GET_MAX_MANA(ch) * attperc) * 0.15;
                int64_t result;
                result = ch_decCurKI(ch, amt, 0);
            } else if (GET_SKILL(ch, SKILL_ERASER) >= 60) {
                int64_t amt = (GET_MAX_MANA(ch) * attperc) * 0.1;
                int64_t result;
                result = ch_decCurKI(ch, amt, 0);
            } else if (GET_SKILL(ch, SKILL_ERASER) >= 40) {
                int64_t amt = (GET_MAX_MANA(ch) * attperc) * 0.05;
                int64_t result;
                result = ch_decCurKI(ch, amt, 0);
            }
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (tech_handle_android_absorb(ch, vict)) {
                    ...
                    act("@C$N@W moves quickly and blocks your eraser cannon!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W eraser cannon!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W eraser cannon!@n", false, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    if (GET_SKILL(ch, SKILL_ERASER) >= 100) {
                    ...
                    act("@WYou can't believe it but your eraser cannon misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a eraser cannon at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a eraser cannon at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
        ...
        dmg = damtype(ch, 18, skill, attperc);
        dmg /= 10;
        act("@WYou fire a eraser cannon at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a eraser cannon at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
        if (GET_SKILL(ch, SKILL_ERASER) >= 100) {
            int64_t amt = (GET_MAX_MANA(ch) * attperc) * 0.15;
...
ACMD(do_pbarrage) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your psychic barrage!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W psychic barrage!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W psychic barrage!@n", false, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@WYou can't believe it but your psychic barrage misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a psychic barrage at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a psychic barrage at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
            ...
            if (!AFF_FLAGGED(vict, AFF_MBREAK) && rand_number(1, 4) == 4 && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
                act("@mYour mind's eye has been shattered, you can't charge ki until you recover!@n", true, vict,
                    NULL, NULL,
                    TO_CHAR);
                act("@M$n@m's mind has been damaged by the attack!@n", true, vict, NULL, NULL, TO_ROOM);
        ...
        dmg = damtype(ch, 31, skill, attperc);
        dmg /= 10;
        act("@WYou fire a psychic barrage at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a psychic barrage at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_geno) {
    ...
    GET_CHARGE(ch) += (ch_getEffMaxPL(ch)) / 10;
    TARGET(obj) = vict;
...
ACMD(do_genki) {
    ...
    for (friend_char = world[IN_ROOM(ch)].people; friend_char; friend_char = next_v) {
        ...
        if (AFF_FLAGGED(friend_char, AFF_GROUP) &&
            ...
            GET_CHARGE(ch) += ((ch_getMaxKI(ch) * ch->energy)) / 10;
            int64_t amt = ch_getMaxKI(ch) * ch->energy / 20;
            int64_t result;
            result = ch_decCurKI(ch, amt, 0);
        }
    }
...
ACMD(do_spiritball) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W deflects your Spirit Ball, sending it flying away!@n", true, ch, NULL, vict,
                        TO_CHAR);
                    act("@WYou deflect @C$n's@W Spirit Ball sending it flying away!@n", true, ch, NULL, vict,
                        TO_VICT);
                    act("@C$N@W deflects @c$n's@W Spirit Ball sending it flying away!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 200);
                    ...
                    act("@C$N@W moves quickly and blocks the Spirit Ball!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Spirit Ball!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Spirit Ball!@n", true, ch, NULL, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W manages to dodge your Spirit Ball, letting it slam into the surroundings!@n", true, ch,
                        NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Spirit Ball, letting it slam into the surroundings!@n", true, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your spirit ball misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a spirit ball at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a spirit ball at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
        ...
        dmg = damtype(ch, 39, skill, attperc);
        dmg /= 10;
        act("@WYou fire a spirit ball at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a spirit ball at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_deathball) {
    ...
    if (vict) {
            ...
            if (((ch_getCurST(vict))) > 0) {
                if (dge > axion_dice(10)) {
                    act("@C$N@W manages to dodge your deathball, letting it slam into the surroundings!@n", false, ch,
                        NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W deathball, letting it slam into the surroundings!@n", false, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your deathball misses, flying through the air harmlessly!@n", false,
                        ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a deathball at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a deathball at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your deathball misses, flying through the air harmlessly!@n", false, ch,
                    NULL, vict, TO_CHAR);
                act("@C$n@W fires a deathball at you, but misses!@n", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a deathball at @C$N@W, but somehow misses!@n", false, ch, NULL, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 38, skill, attperc);
        dmg /= 10;
        act("@WYou fire a deathball at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a deathball at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_pslash) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your Phoenix Slash!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Phoenix Slash!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Phoenix Slash!@n", false, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@WYou can't believe it but your Phoenix Slash misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a Phoenix Slash at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a Phoenix Slash at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
        ...
        if (GET_OBJ_VNUM(obj) == 79)
            dmg *= 3;
        act("@WYou fire a Phoenix Slash at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a Phoenix Slash at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_bigbang) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your Big Bang!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Big Bang!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Big Bang!@n", false, ch, NULL, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W manages to dodge your Big Bang, letting it slam into the surroundings!@n", false, ch,
                        NULL,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Big Bang, letting it slam into the surroundings!@n", false, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your Big Bang misses, flying through the air harmlessly!@n", false,
                        ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a Big Bang at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a Big Bang at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your Big Bang misses, flying through the air harmlessly!@n", false, ch,
                    NULL, vict, TO_CHAR);
                act("@C$n@W fires a Big Bang at you, but misses!@n", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a Big Bang at @C$N@W, but somehow misses!@n", false, ch, NULL, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 36, skill, attperc);
        dmg /= 10;
        act("@WYou fire a Big Bang at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a Big Bang at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_scatter) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks every kiball of your scatter shot!@n", false, ch, NULL,
                        vict,
                        TO_CHAR);
                    act("@WYou move quickly and block every kiball of @C$n's@W scatter shot!@n", false, ch, NULL,
                        vict,
                        TO_VICT);
                    act("@C$N@W moves quickly and blocks every kiball of @c$n's@W scatter shot!@n", false, ch, NULL,
                        vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@WYou can't believe it but all the kiballs of your scatter shot miss, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires scatter shot kiballs at you, but they miss!@n ", false, ch, NULL, vict,
                        TO_VICT);
                    act("@c$n@W fires scatter shot kiballs at @C$N@W, but somehow they miss!@n ", false, ch, NULL,
                        vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but all the kiballs of your scatter shot miss, flying through the air harmlessly!@n",
                    false, ch, NULL, vict, TO_CHAR);
                act("@C$n@W fires scatter shot kiballs at you, but they miss!@n ", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires scatter shot kiballs at @C$N@W, but somehow they miss!@n ", false, ch, NULL, vict,
                    TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 35, skill, attperc);
        dmg /= 10;
        act("@WYou fire a scatter shot at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a scatter shot at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_balefire) {
    ...
    if (vict) {
            ...
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    ...
                    act("@C$N@W manages to dodge your balefire, letting it slam into the surroundings!@n", false, ch,
                        NULL,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W balefire, letting it slam into the surroundings!@n", false, ch, NULL,
                        vict,
                        TO_VICT);
                ...
                act("@WYou can't believe it but all of your balefire misses, flying through the air harmlessly!@n",
                    false, ch, NULL, vict, TO_CHAR);
                act("@C$n@W fires balefire at you, but they miss!@n ", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires balefire at @C$N@W, but somehow they miss!@n ", false, ch, NULL, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 35, skill, attperc);
        dmg /= 10;
        act("@WYou fire balefire at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires balefire at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (count <= 0) {
        ...
        for (vict = world[IN_ROOM(ch)].people; vict; vict = next_v) {
            ...
            if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
                ((ch_getCurST(vict))) >= 1 && GET_POS(vict) != POS_SLEEPING) {
                hits++;
                act("@C$N@c disappears, avoiding the beam chasing $M!@n", false, ch, NULL, vict, TO_CHAR);
                act("@cYou disappear, avoiding the beam chasing you!@n", false, ch, NULL, vict, TO_VICT);
                act("@C$N@c disappears, avoiding the beam chasing $M!@n", false, ch, NULL, vict, TO_NOTVICT);
                ...
                hits++;
                act("@c$N@W manages to escape the attack!@n", true, ch, NULL, vict, TO_CHAR);
                act("@WYou manage to escape the attack!@n", true, ch, NULL, vict, TO_VICT);
                act("@c$N@W manages to escape the attack!@n", true, ch, NULL, vict, TO_NOTVICT);
                improve_skill(vict, SKILL_DODGE, 0);
                hurt(0, 0, ch, vict, NULL, 0, 1);
                continue;
            } else {
                hits++;
                act("@R$N@r is slammed by one of the beams!@n", true, ch, NULL, vict, TO_CHAR);
                act("@RYou are slammed by one of the beams!@n", true, ch, NULL, vict, TO_VICT);
                act("@R$N@r is slammed by one of the beams!@n", true, ch, NULL, vict, TO_NOTVICT);
                hurt(0, 0, ch, vict, NULL, dmg, 1);
                continue;
            }
        } /* Hitting targets! */
        ...
        if (count < 5 && !ROOM_FLAGGED(IN_ROOM(ch), ROOM_SPACE)) {
            ...
            if (SECT(IN_ROOM(ch)) != SECT_INSIDE) {
                ...
                switch (rand_number(1, 8)) {
                    case 1:
                        act("Debris is thrown into the air and showers down thunderously!", true, ch, NULL, NULL,
                            TO_CHAR);
                        act("Debris is thrown into the air and showers down thunderously!", true, ch, NULL, NULL,
                            TO_ROOM);
                        break;
                    case 2:
                        ...
                        break;
                    case 3:
                        act("A cloud of dust envelopes the entire area!", true, ch, NULL, NULL, TO_CHAR);
                        act("A cloud of dust envelopes the entire area!", true, ch, NULL, NULL, TO_ROOM);
                        break;
                    case 4:
                        act("The surrounding area roars and shudders from the impact!", true, ch, NULL, NULL,
                            TO_CHAR);
                        act("The surrounding area roars and shudders from the impact!", true, ch, NULL, NULL,
                            TO_ROOM);
                        break;
                    case 5:
                        act("The ground shatters apart from the stress of the impact!", true, ch, NULL, NULL,
                            TO_CHAR);
                        act("The ground shatters apart from the stress of the impact!", true, ch, NULL, NULL,
                            TO_ROOM);
                        break;
            ...
            if (SECT(IN_ROOM(ch)) == SECT_UNDERWATER) {
                switch (rand_number(1, 3)) {
                    case 1:
                        act("The water churns violently!", true, ch, NULL, NULL, TO_CHAR);
                        act("The water churns violently!", true, ch, NULL, NULL, TO_ROOM);
                        break;
                    case 2:
                        act("Large bubbles rise from the movement!", true, ch, NULL, NULL, TO_CHAR);
                        act("Large bubbles rise from the movement!", true, ch, NULL, NULL, TO_ROOM);
                        break;
                    case 3:
                        act("The water collapses in on the hole created!", true, ch, NULL, NULL, TO_CHAR);
                        act("The water collapses in on the hole create!", true, ch, NULL, NULL, TO_ROOM);
                        break;
                }
            }
            if (SECT(IN_ROOM(ch)) == SECT_WATER_SWIM || SECT(IN_ROOM(ch)) == SECT_WATER_NOSWIM) {
                switch (rand_number(1, 3)) {
                    case 1:
                        act("A huge column of water erupts from the impact!", true, ch, NULL, NULL, TO_CHAR);
                        act("A huge column of water erupts from the impact!", true, ch, NULL, NULL, TO_ROOM);
                        break;
                    case 2:
                        act("The impact briefly causes a swirling vortex of water!", true, ch, NULL, NULL,
                            TO_CHAR);
                        act("The impact briefly causes a swirling vortex of water!", true, ch, NULL, NULL,
                            TO_ROOM);
                        break;
            ...
            if (SECT(IN_ROOM(ch)) == SECT_INSIDE) {
                ...
                switch (rand_number(1, 8)) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        act("Parts of the ceiling collapse, crushing into the floor!", true, ch, NULL, NULL,
                            TO_CHAR);
                        act("Parts of the ceiling collapse, crushing into the floor!", true, ch, NULL, NULL,
                            TO_ROOM);
                        break;
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        act("The walls of the surrounding room crack in the same instant!", true, ch, NULL, NULL,
                            TO_CHAR);
                        act("The walls of the surrounding room crack in the same instant!", true, ch, NULL, NULL,
                            TO_ROOM);
                        break;
...
ACMD(do_hellspear) {
    ...
    if (count <= 0) {
        ...
        for (vict = world[IN_ROOM(ch)].people; vict; vict = next_v) {
            ...
            if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
                ((ch_getCurST(vict))) >= 1 && GET_POS(vict) != POS_SLEEPING) {
                act("@C$N@c disappears, avoiding the explosion before reappearing elsewhere!@n", false, ch, NULL,
                    vict,
                    TO_CHAR);
                act("@cYou disappear, avoiding the explosion before reappearing elsewhere!@n", false, ch, NULL, vict,
                    TO_VICT);
                act("@C$N@c disappears, avoiding the explosion before reappearing elsewhere!@n", false, ch, NULL,
                    vict,
                    TO_NOTVICT);
                ...
                act("@c$N@W manages to escape the explosion!@n", true, ch, NULL, vict, TO_CHAR);
                act("@WYou manage to escape the explosion!@n", true, ch, NULL, vict, TO_VICT);
                act("@c$N@W manages to escape the explosion!@n", true, ch, NULL, vict, TO_NOTVICT);
                hurt(0, 0, ch, vict, NULL, 0, 1);
                improve_skill(vict, SKILL_DODGE, 0);
                continue;
            } else {
                act("@R$N@r is caught by the explosion!@n", true, ch, NULL, vict, TO_CHAR);
                act("@RYou are caught by the explosion!@n", true, ch, NULL, vict, TO_VICT);
                act("@R$N@r is caught by the explosion!@n", true, ch, NULL, vict, TO_NOTVICT);
...
ACMD(do_hellflash) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your Hell Flash!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Hell Flash!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Hell Flash!@n", false, ch, NULL, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_HELLFLASH) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your Hell Flash, letting it slam into the surroundings!@n", false, ch,
                        NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Hell Flash, letting it slam into the surroundings!@n", false, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your Hell Flash misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a Hell Flash at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a Hell Flash at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_HELLFLASH) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                ...
                act("@WYou can't believe it but your Hell Flash misses, flying through the air harmlessly!@n", false,
                    ch, NULL, vict, TO_CHAR);
                act("@C$n@W fires a Hell Flash at you, but misses!@n", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a Hell Flash at @C$N@W, but somehow misses!@n", false, ch, NULL, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_HELLFLASH) == 3 && attperc > minimum) {
                    pcost(ch, attperc - 0.05, 0);
                } else {
                    pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 32, skill, attperc);
        dmg /= 10;
        act("@WYou fire a Hell Flash at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a Hell Flash at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_ddslash) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your Darkness Dragon Slash!@n", false, ch, NULL, vict,
                        TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Darkness Dragon Slash!@n", false, ch, NULL, vict,
                        TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Darkness Dragon Slash!@n", false, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@WYou can't believe it but your Darkness Dragon Slash misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a Darkness Dragon Slash at you, but misses!@n ", false, ch, NULL, vict,
                        TO_VICT);
                    act("@c$n@W fires a Darkness Dragon Slash at @C$N@W, but somehow misses!@n ", false, ch, NULL,
                        vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your Darkness Dragon Slash misses, flying through the air harmlessly!@n",
                    false, ch, NULL, vict, TO_CHAR);
                act("@C$n@W fires a Darkness Dragon Slash at you, but misses!@n", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a Darkness Dragon Slash at @C$N@W, but somehow misses!@n", false, ch, NULL, vict,
                    TO_NOTVICT);
                pcost(ch, attperc, 0);
            ...
            if (rand_number(1, 3) == 3 && !AFF_FLAGGED(vict, AFF_BLIND)) {
                act("@mYou are struck blind temporarily!@n", true, vict, NULL, NULL, TO_CHAR);
                act("@c$n@m is struck blind by the attack!@n", true, vict, NULL, NULL, TO_ROOM);
                int duration = 1;
        ...
        dmg = damtype(ch, 30, skill, attperc);
        dmg /= 10;
        act("@WYou fire a Darkness Dragon Slash at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a Darkness Dragon Slash at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_crusher) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your crusher ball!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W crusher ball!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W crusher ball!@n", false, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_CRUSHER) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                    ...
                    act("@WYou can't believe it but your crusher ball misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a crusher ball at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a crusher ball at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_CRUSHER) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
        ...
        dmg = damtype(ch, 29, skill, attperc);
        dmg /= 10;
        act("@WYou fire a crusher ball at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a crusher ball at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_final) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your final flash!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W final flash!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W final flash!@n", false, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@WYou can't believe it but your final flash misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a final flash at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a final flash at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
        ...
        dmg = damtype(ch, 28, skill, attperc);
        dmg /= 10;
        act("@WYou fire a final flash at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a final flash at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_sbc) {
    ...
    if (vict) {
            ...
            if (((ch_getCurST(vict))) > 0) {
                if (dge > axion_dice(10)) {
                    ...
                    act("@WYou can't believe it but your special beam cannon misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a special beam cannon at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a special beam cannon at @C$N@W, but somehow misses!@n ", false, ch, NULL,
                        vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your special beam cannon misses, flying through the air harmlessly!@n",
                    false, ch, NULL, vict, TO_CHAR);
                act("@C$n@W fires a special beam cannon at you, but misses!@n", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a special beam cannon at @C$N@W, but somehow misses!@n", false, ch, NULL, vict,
                    TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 27, skill, attperc);
        dmg /= 10;
        act("@WYou fire a special beam cannon at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a special beam cannon at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_tribeam) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your tribeam!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W tribeam!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W tribeam!@n", false, ch, NULL, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W manages to dodge your tribeam, letting it slam into the surroundings!@n", false, ch,
                        NULL,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W tribeam, letting it slam into the surroundings!@n", false, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your tribeam misses, flying through the air harmlessly!@n", false,
                        ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a tribeam at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a tribeam at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your tribeam misses, flying through the air harmlessly!@n", false, ch,
                    NULL, vict, TO_CHAR);
                act("@C$n@W fires a tribeam at you, but misses!@n", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a tribeam at @C$N@W, but somehow misses!@n", false, ch, NULL, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 26, skill, attperc);
        dmg /= 10;
        act("@WYou fire a tribeam at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a tribeam at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_kienzan) {
    ...
    if (vict) {
            ...
            if (((ch_getCurST(vict))) > 0) {
                if (dge > axion_dice(10)) {
                    act("@C$N@W manages to dodge your kienzan, letting it slam into the surroundings!@n", false, ch,
                        NULL,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W kienzan, letting it slam into the surroundings!@n", false, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your kienzan misses, flying through the air harmlessly!@n", false,
                        ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a kienzan at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a kienzan at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your kienzan misses, flying through the air harmlessly!@n", false, ch,
                    NULL, vict, TO_CHAR);
                act("@C$n@W fires a kienzan at you, but misses!@n", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a kienzan at @C$N@W, but somehow misses!@n", false, ch, NULL, vict, TO_NOTVICT);
            ...
            switch (hitspot) {
                case 1:
                    ...
                    act("@C$n@W raises $s hand above $s head and pools $s charged ki above $s flattened palm. Slowly a golden spinning disk of energy grows from the ki. With the attack complete $e shouts '@yK@Yi@we@yn@Yz@wa@yn@W!' and throws it! @C$n@W watches as it slices into @c$N@W's body!@n",
                        true, ch, NULL, vict, TO_NOTVICT);
                    if (dmg > (ch_getEffMaxPL(vict)) / 5 && (!IS_MAJIN(vict) && !IS_BIO(vict))) {
                        act("@R$N@r is cut in half by the attack!@n", true, ch, NULL, vict, TO_CHAR);
                        act("@rYou are cut in half by the attack!@n", true, ch, NULL, vict, TO_VICT);
                        act("@R$N@r is cut in half by the attack!@n", true, ch, NULL, vict, TO_NOTVICT);
                        die(vict, ch);
                        if (AFF_FLAGGED(ch, AFF_GROUP)) {
                            group_gain(ch, vict);
                        } else {
                ...
                case 4: /* Weak */
                    ...
                    if (rand_number(1, 100) >= 70 && !IS_NPC(vict) && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
                        if (GET_LIMBCOND(vict, 2) > 0 && !is_sparring(ch) && rand_number(1, 2) == 2) {
                            act("@RYour attack severes $N's left arm!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@R$n's attack severes your left arm!@n", true, ch, NULL, vict, TO_VICT);
                            act("@R$N's left arm is severed in the attack!@n", true, ch, NULL, vict, TO_NOTVICT);
                            GET_LIMBCOND(vict, 2) = 0;
                            remove_limb(vict, 2);
                        } else if (GET_LIMBCOND(vict, 1) > 0 && !is_sparring(ch)) {
                            act("@RYour attack severes $N's right arm!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@R$n's attack severes your right arm!@n", true, ch, NULL, vict, TO_VICT);
                            act("@R$N's right arm is severed in the attack!@n", true, ch, NULL, vict, TO_NOTVICT);
                            GET_LIMBCOND(vict, 1) = 0;
                            remove_limb(vict, 1);
                        }
                    }
                ...
                case 5: /* Weak 2 */
                    ...
                    if (rand_number(1, 100) >= 70 && !IS_NPC(vict) && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
                        if (GET_LIMBCOND(vict, 4) > 0 && !is_sparring(ch) && rand_number(1, 2) == 2) {
                            act("@RYour attack severes $N's left leg!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@R$n's attack severes your left leg!@n", true, ch, NULL, vict, TO_VICT);
                            act("@R$N's left leg is severed in the attack!@n", true, ch, NULL, vict, TO_NOTVICT);
                            GET_LIMBCOND(vict, 4) = 0;
                            remove_limb(vict, 4);
                        } else if (GET_LIMBCOND(vict, 3) > 0 && !is_sparring(ch)) {
                            act("@RYour attack severes $N's right leg!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@R$n's attack severes your right leg!@n", true, ch, NULL, vict, TO_VICT);
                            act("@R$N's right leg is severed in the attack!@n", true, ch, NULL, vict, TO_NOTVICT);
                            GET_LIMBCOND(vict, 3) = 0;
                            remove_limb(vict, 3);
                        }
                    }
        ...
        dmg = damtype(ch, 25, skill, attperc);
        dmg /= 10;
        act("@WYou fire a kienzan at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a kienzan at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_rogafufuken) {
    ...
    if (!check_points(ch, GET_MAX_MANA(ch) * minimum, (ch_getEffMaxPL(ch)) / 50)) {
        return;
    }
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your rogafufuken with a punch of $s own!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W rogafufuken with a punch of your own!@n", false, ch, NULL, vict,
                        TO_VICT);
                    act("@C$N@W parries @c$n's@W rogafufuken with a punch of $s own!@n", false, ch, NULL, vict,
                        TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, (ch_getEffMaxPL(vict)) / 300);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W moves quickly and blocks your rogafufuken!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W rogafufuken!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W rogafufuken!@n", false, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W manages to dodge your rogafufuken!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W rogafufuken!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W rogafufuken!@n", false, ch, NULL, vict, TO_NOTVICT);
                    ...
                    act("@WYou can't believe it but your rogafufuken misses!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a rogafufuken at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a rogafufuken at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
        ...
        dmg = damtype(ch, 23, skill, attperc);
        dmg /= 10;
        act("@WYou fire a rogafufuken at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a rogafufuken at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        while (hits > 0) {
            ...
            if (prob < perc - 20) {
                if (((ch_getCurST(vict))) > 0) {
                    if (blk > axion_dice(10)) {
                        act("@C$N@W moves quickly and blocks your dualbeam!@n", false, ch, NULL, vict, TO_CHAR);
                        act("@WYou move quickly and block @C$n's@W dualbeam!@n", false, ch, NULL, vict, TO_VICT);
                        act("@C$N@W moves quickly and blocks @c$n's@W dualbeam!@n", false, ch, NULL, vict,
                            TO_NOTVICT);
                        if (hits == 1) {
                            pcost(ch, attperc, 0);
                        }
                        ...
                        act("@WYou can't believe it but your dualbeam misses, flying through the air harmlessly!@n",
                            false, ch, NULL, vict, TO_CHAR);
                        act("@C$n@W fires a dualbeam at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                        act("@c$n@W fires a dualbeam at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                            TO_NOTVICT);
        ...
        dmg = damtype(ch, 22, skill, attperc);
        dmg /= 10;
        act("@WYou fire a dualbeam at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a dualbeam at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_blessedhammer) {
    ...
    if (vict) {
        ...
        dmg = damtype(ch, 42, skill, attperc);
        dmg /= 10;
        act("@WYou fire a @WB@Dl@We@Ds@Ws@De@Wd @DH@Wa@Dm@Wm@De@Wr at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a @WB@Dl@We@Ds@Ws@De@Wd @DH@Wa@Dm@Wm@De@Wr at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_kousengan) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your kousengan!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W kousengan!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W kousengan!@n", false, ch, NULL, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    dmg = damtype(ch, 42, skill, attperc);
                    dmg /= 4;
                    ...
                    act("@C$N@W manages to dodge your kousengan, letting it slam into the surroundings!@n", false, ch,
                        NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W kousengan, letting it slam into the surroundings!@n", false, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your kousengan misses, flying through the air harmlessly!@n", false,
                        ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a kousengan at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a kousengan at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your kousengan misses, flying through the air harmlessly!@n", false, ch,
                    NULL, vict, TO_CHAR);
                act("@C$n@W fires a kousengan at you, but misses!@n", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a kousengan at @C$N@W, but somehow misses!@n", false, ch, NULL, vict, TO_NOTVICT);
                pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 42, skill, attperc);
        dmg /= 10;
        act("@WYou fire a kousengan at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a kousengan at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_deathbeam) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your deathbeam!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W deathbeam!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W deathbeam!@n", false, ch, NULL, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_DEATHBEAM) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your deathbeam, letting it slam into the surroundings!@n", false, ch,
                        NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W deathbeam, letting it slam into the surroundings!@n", false, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your deathbeam misses, flying through the air harmlessly!@n", false,
                        ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a deathbeam at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a deathbeam at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_DEATHBEAM) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                ...
                act("@WYou can't believe it but your deathbeam misses, flying through the air harmlessly!@n", false, ch,
                    NULL, vict, TO_CHAR);
                act("@C$n@W fires a deathbeam at you, but misses!@n", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a deathbeam at @C$N@W, but somehow misses!@n", false, ch, NULL, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_DEATHBEAM) == 3 && attperc > minimum) {
                    pcost(ch, attperc - 0.05, 0);
                } else {
                    pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 17, skill, attperc);
        dmg /= 10;
        act("@WYou fire a deathbeam at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a deathbeam at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
        if (GET_SKILL_PERF(ch, SKILL_DEATHBEAM) == 3) {
            WAIT_STATE(ch, PULSE_3SEC);
...
ACMD(do_dodonpa) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks your dodonpa!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W dodonpa!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W dodonpa!@n", false, ch, NULL, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_DODONPA) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your dodonpa, letting it slam into the surroundings!@n", false, ch,
                        NULL,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W dodonpa, letting it slam into the surroundings!@n", false, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your dodonpa misses, flying through the air harmlessly!@n", false,
                        ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a dodonpa at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a dodonpa at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_DODONPA) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                ...
                act("@WYou can't believe it but your dodonpa misses, flying through the air harmlessly!@n", false, ch,
                    NULL, vict, TO_CHAR);
                act("@C$n@W fires a dodonpa at you, but misses!@n", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a dodonpa at @C$N@W, but somehow misses!@n", false, ch, NULL, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_DODONPA) == 3 && attperc > minimum) {
                    pcost(ch, attperc - 0.05, 0);
                } else {
                    pcost(ch, attperc, 0);
            ...
            if (rand_number(1, 3) == 2) {
                int64_t result;
                result = ch_decCurKI(vict, dmg / 4, 0);
        ...
        dmg = damtype(ch, 15, skill, attperc);
        dmg /= 10;
        act("@WYou fire a dodonpa at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a dodonpa at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_masenko) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (tech_handle_android_absorb(ch, vict)) {
                    ...
                    act("@C$N@W moves quickly and blocks your masenko!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W masenko!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W masenko!@n", false, ch, NULL, vict, TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_MASENKO) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                        pcost(ch, attperc, 0);
                    ...
                    act("@C$N@W manages to dodge your masenko, letting it slam into the surroundings!@n", false, ch,
                        NULL,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W masenko, letting it slam into the surroundings!@n", false, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your masenko misses, flying through the air harmlessly!@n", false,
                        ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a masenko at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a masenko at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_MASENKO) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                ...
                act("@WYou can't believe it but your masenko misses, flying through the air harmlessly!@n", false, ch,
                    NULL, vict, TO_CHAR);
                act("@C$n@W fires a masenko at you, but misses!@n", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a masenko at @C$N@W, but somehow misses!@n", false, ch, NULL, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_MASENKO) == 3 && attperc > minimum) {
                    pcost(ch, attperc - 0.05, 0);
                } else {
                    pcost(ch, attperc, 0);
            ...
            if (rand_number(1, 2) == 2 && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
                ...
                int64_t result;
                result = ch_decCurST(vict, dmg / 4, 0);
            }
            if (GET_SKILL_PERF(ch, SKILL_MASENKO) == 3 && attperc > minimum) {
                pcost(ch, attperc - 0.05, 0);
            } else {
        ...
        dmg = damtype(ch, 14, skill, attperc);
        dmg /= 10;
        act("@WYou fire a masenko at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a masenko at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    ...
    if (vict) {
        ...
        if (!tech_handle_zanzoken(ch, vict, "KameHameHa Wave")) {
            ...
            if (GET_SKILL(ch, SKILL_KAMEHAMEHA) >= 100) {
                int64_t amt = (GET_MAX_MANA(ch) * attperc) * 0.25;
                int64_t result;
                result = ch_incCurKI(ch, amt, true);
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (tech_handle_android_absorb(ch, vict)) {
                    ...
                    act("@C$N@W moves quickly and blocks your kamehameha!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W kamehameha!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W kamehameha!@n", false, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    if (GET_SKILL_PERF(ch, SKILL_KAMEHAMEHA) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                    ...
                    act("@C$N@W manages to dodge your kamehameha, letting it slam into the surroundings!@n", false, ch,
                        NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W kamehameha, letting it slam into the surroundings!@n", false, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your kamehameha misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a kamehameha at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a kamehameha at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_KAMEHAMEHA) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                ...
                act("@WYou can't believe it but your kamehameha misses, flying through the air harmlessly!@n", false,
                    ch, NULL, vict, TO_CHAR);
                act("@C$n@W fires a kamehameha at you, but misses!@n", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a kamehameha at @C$N@W, but somehow misses!@n", false, ch, NULL, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_KAMEHAMEHA) == 3 && attperc > minimum) {
                    pcost(ch, attperc - 0.05, 0);
                } else {
                    pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 13, skill, attperc);
        dmg /= 10;
        act("@WYou fire a kamehameha at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a kamehameha at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        if (GET_SKILL_PERF(ch, SKILL_KAMEHAMEHA) == 3) {
            WAIT_STATE(ch, PULSE_3SEC);
        }
        hurt(0, 0, ch, NULL, obj, dmg, 0);
...
ACMD(do_renzo) {
    ...
    if (vict) {
            ...
            if (((ch_getCurST(vict))) > 0) {
                if (tech_handle_android_absorb(ch, vict)) {
                    ...
                    act("@C$N@W moves quickly and blocks every renzokou energy dan shot with $S arms!@n", true, ch,
                        NULL,
                        vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W renzokou energy dan!@n", true, ch, NULL, vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but all your renzokou energy dan shots miss, flying through the air harmlessly!@n",
                        true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires hundreds of renzokou energy dan shots at you, but misses!@n ", true, ch, NULL,
                        vict,
                        TO_VICT);
                ...
                act("@WYou can't believe it but all your renzokou energy dan shots miss, flying through the air harmlessly!@n",
                    true, ch, NULL, vict, TO_CHAR);
                act("@C$n@W fires hundreds of renzokou energy dan shots at you, but misses!@n", true, ch, NULL, vict,
                    TO_VICT);
        ...
        dmg = damtype(ch, 12, skill, attperc);
        dmg /= 10;
        act("@WYou fire hundreds of renzokou energy dan shots at $p@W!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires hundreds of renzokou energy dan shots at $p@W!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_heeldrop) {
    ...
    if (!check_points(ch, 0, (ch_getEffMaxPL(ch)) / 90)) {
        return;
    }
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your heeldrop with a punch of $S own!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W heeldrop with a punch of your own!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W heeldrop with a punch of $S own!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W moves quickly and blocks your heeldrop!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W heeldrop!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W heeldrop!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W manages to dodge your heeldrop!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W heeldrop!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W heeldrop!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    ...
                    act("@WYou can't believe it but your heeldrop misses!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W moves to heeldrop you, but misses!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W moves to heeldrop @C$N@W, but somehow misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                ...
                case 2: /* Critical */
                    ...
                    break;
                case 3:
                    act("@WYou fly at @C$N@W, heeldropping $S gut as you fly!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W flies at you, heeldropping your gut as $e flies!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W flies at @C$N@W, heeldropping $S gut as $e flies!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou heeldrop @C$N@W, hitting $M in the arm!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W heeldrops you, hitting you in the arm!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W heeldrops @C$N@W, hitting $M in the arm!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    ...
                    break;
                case 5: /* Weak 2 */
                    act("@WYou heeldrop @C$N's@W leg!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W heeldrops your leg!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W heeldrops @C$N's@W leg!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
        ...
        act("@WYou heeldrop $p@W as hard as you can!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W heeldrops $p@W extremely hard!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_attack) {
    ...
    int64_t stcost = ((ch_getEffMaxPL(ch)) / 150);
    int64_t dmg;
    struct char_data *vict;
    ...
    if (vict) {
        ...
        if (!tech_handle_zanzoken(ch, vict, "attack")) {
            if ((wielded == 2 && gun == false) || (gun2 == false && gun == false))
                pcost(ch, 0, stcost / 3);
            pcost(vict, 0, (ch_getEffMaxPL(vict)) / 150);
            return;
        }
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W intercepts and parries your attack with $S own!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou intercept and parry @C$n's@W attack with one of your own!@n", true, ch, NULL, vict,
                        TO_VICT);
                    act("@C$N@W intercepts and parries @c$n's@W attack with one of $S own!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    if (wtype != 4)
                    ...
                    act("@C$N@W moves quickly and blocks your attack!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W attack!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W attack!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    if ((wielded == 2 && gun == false) || (gun2 == false && gun == false))
                        pcost(ch, 0, stcost);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W manages to dodge your attack!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W attack!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W attack!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    if ((wielded == 2 && gun == false) || (gun2 == false && gun == false))
                        pcost(ch, 0, stcost);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it but your attack misses!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W moves to attack you, but misses!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W moves to attack @C$N@W, but somehow misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                    if ((wielded == 2 && gun == false) || (gun2 == false && gun == false))
                        pcost(ch, 0, stcost / 3);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (wtype) {
                case 0:
                    switch (hitspot) {
                        case 1:
                            act("@WYou slash @C$N@W across the stomach!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W slashes you across the stomach!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W slashes @C$N@W across the stomach!@n", true, ch, NULL, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 2:
                            act("@WYou slash @C$N@W across the arm!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W slashes you across the arm!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W slashes @C$N@W across the arm!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 1);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 3:
                            act("@WYou slash @C$N@W across the leg!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W slashes you across the leg!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W slashes @C$N@W across the leg!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 2);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 4:
                            act("@WYou slash @C$N@W across the face!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W slashes you across the face!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W slashes @C$N@W across the face!@n", true, ch, NULL, vict, TO_NOTVICT);
                            if (!IS_NPC(ch)) {
                                if (PLR_FLAGGED(ch, PLR_THANDW) && gun == false && gun2 == false) {
                                    if (GET_SKILL_BASE(ch, SKILL_TWOHAND) >= 100) {
                            ...
                            break;
                        case 5:
                            act("@WYou slash @C$N@W across the chest!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W slashes you across the chest!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W slashes @C$N@W across the chest!@n", true, ch, NULL, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                    }/* end slash switch*/
                    if (beforepl - GET_HIT(vict) >= (ch_getEffMaxPL(vict)) * 0.025) {
                ...
                case 1:
                    ...
                    switch (hitspot) {
                        case 1:
                            act("@WYou pierce @C$N's@W stomach!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W pierces your stomach!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W pierces @C$N's@W stomach!@n", true, ch, NULL, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 2:
                            act("@WYou pierce @C$N's@W arm!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W pierces your arm!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W pierces @C$N's@W arm!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 1);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 3:
                            act("@WYou pierce @C$N's@W leg!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W pierces your leg!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W pierces @C$N's@W leg!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 2);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 4:
                            act("@WYou pierce @C$N's@W face!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W pierces your face!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W pierces @C$N's@W face!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 0);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 3);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 5:
                            act("@WYou pierce @C$N's@W chest!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W pierces your chest!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W pierces @C$N's@W chest!@n", true, ch, NULL, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                ...
                case 2:
                    switch (hitspot) {
                        case 1:
                            act("@WYou crush @C$N's@W chest!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W crushes your chest!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W crushes @C$N's@W chest@n", true, ch, NULL, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 2:
                            act("@WYou crush @C$N's@W arm!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W crushes your arm!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W crushes @C$N's@W arm!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 1);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 3:
                            act("@WYou crush @C$N's@W leg!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W crushes your leg!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W crushes @C$N's@W leg!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 2);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 4:
                            act("@WYou crush @C$N@W in the face!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W crushes you in the face!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W crushes @C$N@W in the face!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 0);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 3);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 5:
                            act("@WYou crush @C$N's@W stomach!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W crushes your stomach!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W crushes @C$N's@W stomach@n", true, ch, NULL, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                ...
                case 3:
                    switch (hitspot) {
                        case 1:
                            act("@WYou stab @C$N's@W chest!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W stabs your chest!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W stabs @C$N's@W chest!@n", true, ch, NULL, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 2:
                            act("@WYou stab @C$N's@W arm!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W stabs your arm!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W stabs @C$N's@W arm!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 1);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 3:
                            act("@WYou stab @C$N's@W leg!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W stabs your leg!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W stabs @C$N's@W leg!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 2);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 4:
                            act("@WYou stab @C$N@W in the face!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W stabs you in the face!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W stabs @C$N@W in the face!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 0);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 3);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 5:
                            act("@WYou stab @C$N's@W stomach!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W stabs your stomach!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W stabs @C$N's@W stomach@n", true, ch, NULL, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                ...
                case 4:
                    switch (hitspot) {
                        case 1:
                            act("@WYou blast @C$N's@W chest!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W blasts your chest!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W blasts @C$N's@W chest!@n", true, ch, NULL, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 2:
                            act("@WYou blast @C$N's@W arm!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W blasts your arm!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W blasts @C$N's@W arm!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 1);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 3:
                            act("@WYou blast @C$N's@W leg!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W blasts your leg!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W blasts @C$N's@W leg!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 2);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 4:
                            act("@WYou blast @C$N@W in the face!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W blasts you in the face!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W blasts @C$N@W in the face!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 0);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 3);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 5:
                            act("@WYou blast @C$N's@W stomach!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W blasts your stomach!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W blasts @C$N's@W stomach@n", true, ch, NULL, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                ...
                case 5:
                    switch (hitspot) {
                        case 1:
                            act("@WYou whack @C$N's@W chest!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W whacks your chest!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W whacks @C$N's@W chest!@n", true, ch, NULL, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 2:
                            act("@WYou whack @C$N's@W arm!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W whacks your arm!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W whacks @C$N's@W arm!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 1);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 3:
                            act("@WYou whack @C$N's@W leg!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W whacks your leg!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W whacks @C$N's@W leg!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 2);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
                        case 4:
                            act("@WYou whack @C$N@W in the face!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W whacks you in the face!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W whacks @C$N@W in the face!@n", true, ch, NULL, vict, TO_NOTVICT);
                            if (GET_SKILL(ch, SKILL_BRAWL) >= 100) {
                                double mult = calc_critical(ch, 0);
                                mult += 1.0;
                                dmg *= mult;
                            ...
                            break;
                        case 5:
                            act("@WYou whack @C$N's@W stomach!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W whacks your stomach!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W whacks @C$N's@W stomach@n", true, ch, NULL, vict, TO_NOTVICT);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 4);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                            break;
        ...
        if ((wielded == 2 && gun == false) || (gun2 == false && gun == false)) {
            if (GET_EQ(ch, WEAR_WIELD1)) {
                if (GET_HIT(vict) > 0 && !AFF_FLAGGED(vict, AFF_SPIRIT) && AFF_FLAGGED(vict, AFF_FIRESHIELD) &&
                    ...
                    act("@c$N's@W fireshield burns your weapon!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n's@W weapon is burned by your fireshield!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n's@W weapon is burned by @C$N's@W fireshield!@n", true, ch, NULL, vict, TO_NOTVICT);
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou attack $p@W as hard as you can!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W attacks $p@W extremely hard!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        if ((wielded == 2 && gun == false) || (gun2 == false && gun == false))
            pcost(ch, 0, stcost);
...
ACMD(do_shogekiha) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@C$N@W moves quickly and blocks shogekiha!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W shogekiha!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W shogekiha!@n", true, ch, NULL, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W manages to dodge your shogekiha, letting it slam into the surroundings!@n", true, ch,
                        NULL,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W shogekiha, letting it slam into the surroundings!@n", true, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your shogekiha misses, flying through the air harmlessly!@n", true,
                        ch, NULL, vict, TO_CHAR);
                    act("@C$n@W aims $s hand and releases a shogekiha at you, but misses!@n ", true, ch, NULL, vict,
                        TO_VICT);
                ...
                act("@C$n@W aims $s hand and releases a shogekiha at you, but misses!@n", true, ch, NULL, vict,
                    TO_VICT);
                act("@c$n@W aims $s hand and releases a shogekiha at @C$N@W, but somehow misses!@n", true, ch, NULL,
                    vict,
                    TO_NOTVICT);
                pcost(ch, attperc, 0);
            ...
            if (IS_KABITO(ch)) {
                if (GET_SKILL(ch, SKILL_SHOGEKIHA) >= 100) {
                    int64_t amt = (ch_getMaxKI(ch) * attperc) * .15;
                    int64_t result;
                    result = ch_incCurKI(ch, amt, true);
                } else if (GET_SKILL(ch, SKILL_SHOGEKIHA) >= 60) {
                    int64_t amt = (ch_getMaxKI(ch) * attperc) * .1;
                    int64_t result;
                    result = ch_incCurKI(ch, amt, true);
                } else if (GET_SKILL(ch, SKILL_SHOGEKIHA) >= 40) {
                    int64_t amt = (ch_getMaxKI(ch) * attperc) * .05;
                    int64_t result;
                    result = ch_incCurKI(ch, amt, true);
                }
            }
            ...
            if (master_pass == true) {
                act("@CYour skillful shogekiha disipated some of @c$N's@C charged ki!@n", true, ch, NULL, vict,
                    TO_CHAR);
                act("@C$n@C's skillful shogekiha disipated some of YOUR charged ki!@n", true, ch, NULL, vict,
                    TO_VICT);
                act("@C$n@C's skillful shogekiha disipated some of @c$N's@C charged ki!", true, ch, NULL, vict,
                    TO_NOTVICT);
        ...
        if (KICHARGE(obj) > 0 && GET_CHARGE(ch) > KICHARGE(obj)) {
            ...
            dmg = damtype(ch, 10, skill, attperc);
            dmg /= 10;
            act("@WYou fire a shogekiha at $p@W!@n", true, ch, obj, NULL, TO_CHAR);
            act("@C$n@W fires a shogekiha at $p@W!@n", true, ch, obj, NULL, TO_ROOM);
            hurt(0, 0, ch, NULL, obj, dmg, 0);
            pcost(ch, attperc, 0);
        }
...
ACMD(do_tsuihidan) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (tech_handle_android_absorb(ch, vict)) {
                    ...
                    act("@C$N@W deflects your tsuihidan, sending it flying away!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou deflect @C$n's@W tsuihidan sending it flying away!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W deflects @c$n's@W tsuihidan sending it flying away!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 200);
                    ...
                    act("@C$N@W moves quickly and blocks tsuihidan!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W tsuihidan!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W tsuihidan!@n", true, ch, NULL, vict, TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W manages to dodge your tsuihidan, letting it slam into the surroundings!@n", true, ch,
                        NULL,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W tsuihidan, letting it slam into the surroundings!@n", true, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your tsuihidan misses, flying through the air harmlessly!@n", true,
                        ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a tsuihidan at you, but misses!@n ", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a tsuihidan at @C$N@W, but somehow misses!@n ", true, ch, NULL, vict,
                        TO_NOTVICT);
                ...
                act("@WYou can't believe it but your tsuihidan misses, flying through the air harmlessly!@n", true, ch,
                    NULL, vict, TO_CHAR);
                act("@C$n@W fires a tsuihidan at you, but misses!@n", true, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a tsuihidan at @C$N@W, but somehow misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                dodge_ki(ch, vict, 1, 11, skill, SKILL_TSUIHIDAN); /* Effects on the room from dodging a ki attack
                               Num 1: [ 0 for non-homing, 1 for homing ki attacks, 2 for guided ]
                               Num 2: [ Number of attack for damtype ]*/
            ...
            if (master_pass == true) {
                int64_t result;
                result = ch_decCurST(vict, dmg, 0);
                act("@CYour tsuihidan hits a vital spot and seems to sap some of @c$N's@C stamina!@n", true, ch,
                    NULL,
                    vict, TO_CHAR);
                act("@C$n's@C tsuihidan hits a vital spot and saps some of your stamina!@n", true, ch, NULL, vict,
                    TO_VICT);
                act("@C$n's@C tsuihidan hits a vital spot and saps some of @c$N's@C stamina!", true, ch, NULL, vict,
                    TO_NOTVICT);
            }
            pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 11, skill, attperc);
        dmg /= 10;
        act("@WYou fire a tsuihidan at $p@W!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a tsuihidan at $p@W!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_attack2) {
    ...
    int64_t stcost = (((ch_getEffMaxPL(ch)) / 150) + GET_OBJ_WEIGHT(GET_EQ(ch, WEAR_WIELD2)));
    int64_t kicost = (((ch_getEffMaxPL(ch)) / 150) + GET_OBJ_WEIGHT(GET_EQ(ch, WEAR_WIELD2)));
                ...
                case 1:
                    ...
                    switch (hitspot) {
                        ...
                        case 2:
                            act("@WYou pierce @C$N's@W arm!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W pierces your arm!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W pierces @C$N'@W arm!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 1);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 1);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                ...
                case 2:
                    switch (hitspot) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            act("@WYou crush @C$N's@W face!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W crushes your face!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W crushes @C$N'@W face!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 0);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 3);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                ...
                case 3:
                    switch (hitspot) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            act("@WYou stab @C$N's@W face!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W stabs your face!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W stabs @C$N'@W face!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 0);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 3);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                ...
                case 4:
                    switch (hitspot) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            act("@WYou blast @C$N's@W face!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W blasts your face!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W blasts @C$N'@W face!@n", true, ch, NULL, vict, TO_NOTVICT);
                            dmg *= calc_critical(ch, 0);
                            hurt(0, 0, ch, vict, NULL, dmg, 0);
                            dam_eq_loc(vict, 3);
                            /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                ...
                case 5:
                    switch (hitspot) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            act("@WYou whack @C$N's@W face!@n", true, ch, NULL, vict, TO_CHAR);
                            act("@c$n@W whacks your face!@n", true, ch, NULL, vict, TO_VICT);
                            act("@c$n@W whacks @C$N'@W face!@n", true, ch, NULL, vict, TO_NOTVICT);
                            if (GET_SKILL(ch, SKILL_BRAWL) >= 100) {
                                double mult = calc_critical(ch, 0);
                                mult += 1.0;
                                dmg *= mult;
...
ACMD(do_bite) {
    ...
    int64_t dmg, stcost = 20 + ((ch_getEffMaxPL(ch)) / 500);
    struct char_data *vict;
    struct obj_data *obj;
    char arg[MAX_INPUT_LENGTH];
    double attperc = 0;
    ...
    if (!check_points(ch, 0, (ch_getEffMaxPL(ch)) / 200)) {
        return;
    }
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your bite with a punch of their own!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W bite with a punch of your own!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W bite with a punch of $S own!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W moves quickly and blocks your bite!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W bite!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W bite!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W manages to dodge your bite!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W bite!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W bite!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou move to bite @C$N@W, but miss!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W moves to bite you, but misses!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W moves to bite @C$N@W, but somehow misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou bite @C$N's@W face!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W bites your face!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W bites into $N's face!@n", true, ch, NULL, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou bite @C$N@W!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W bites you!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$n@W bites @c$N@W!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 4);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 3:
                    act("@WYou bite @C$N's@W body!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W bites you on the body, sending blood flying!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$n@W bites @c$N@W on the body, sending blood flying!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou bite @C$N's@W arm!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W bites you on the arm!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$n@W bites @c$N@W on the arm!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak 2 */
                    act("@WYou bite @C$N's@W leg!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W bites into your leg!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W bites into @c$N's@W leg!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
            ...
            if (!IS_NPC(ch)) {
                if (axion_dice(0) > GET_CON(vict) && rand_number(1, 5) == 5) {
                    act("@R$N@r was poisoned by your bite!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@rYou were poisoned by the bite!@n", true, ch, NULL, vict, TO_VICT);
                    vict->poisonby = ch;
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@C$n@W bites $p@W extremely hard!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_kiball) {
    ...
    if (vict) {
        ...
        if (!tech_handle_zanzoken(ch, vict, "kiball")) {
            if (frompool == true) {
                int64_t amt = ch_getMaxKI(ch) * attperc;
                int64_t result;
                result = ch_decCurKI(ch, amt, 0);
            } else {
                pcost(ch, attperc, 0);
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (tech_handle_android_absorb(ch, vict)) {
                    ...
                    act("@C$N@W deflects your kiball, sending it flying away!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou deflect @C$n's@W kiball sending it flying away!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W deflects @c$n's@W kiball sending it flying away!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 200);
                    ...
                    act("@C$N@W moves quickly and blocks kiball!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W kiball!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W kiball!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W manages to dodge your kiball, letting it slam into the surroundings!@n", true, ch,
                        NULL,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W kiball, letting it slam into the surroundings!@n", true, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your kiball misses, flying through the air harmlessly!@n", true, ch,
                        NULL, vict, TO_CHAR);
                    act("@C$n@W fires a bright yellow kiball at you, but misses!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a bright yellow kiball at @C$N@W, but somehow misses!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
            ...
            if (mult_count > 1) {
                act("@CYour expertise has allowed you to fire multiple shots in a row!@n", true, ch, NULL, vict,
                    TO_CHAR);
                act("@C$n's@C expertise has allowed $m to fire multiple shots in a row!@n", true, ch, NULL, vict,
                    TO_ROOM);
            }
            while (mult_count > 0) {
                mult_count -= 1;
        ...
        dmg = damtype(ch, 7, skill, attperc);
        dmg /= 10;
        act("@WYou fire a kiball at $p@W!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a kiball at $p@W!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_beam) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (tech_handle_android_absorb(ch, vict)) {
                    ...
                    act("@C$N@W deflects your beam, sending it flying away!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou deflect @C$n's@W beam sending it flying away!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W deflects @c$n's@W beam sending it flying away!@n", true, ch, NULL, vict, TO_NOTVICT);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 200);
                    ...
                    act("@C$N@W moves quickly and blocks beam!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W beam!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W beam!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    dmg = damtype(ch, 10, skill, attperc);
                    ...
                    act("@C$N@W manages to dodge your beam, letting it slam into the surroundings!@n", true, ch,
                        NULL,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W beam, letting it slam into the surroundings!@n", true, ch, NULL, vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your beam misses, flying through the air harmlessly!@n", true, ch,
                        NULL, vict, TO_CHAR);
                    act("@C$n@W fires a bright yellow beam at you, but misses!@n ", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a bright yellow beam at @C$N@W, but somehow misses!@n ", true, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
            ...
            if (GET_HIT(vict) > 0 && dmg > (ch_getEffMaxPL(vict)) / 4 && master_pass == true) {
                ...
                if (CAN_GO(vict, attempt)) {
                    act("$N@W is pushed away by the blast!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou are pushed away by the blast!@n", true, ch, NULL, vict, TO_VICT);
                    act("$N@W is pushed away by the blast!@n", true, ch, NULL, vict, TO_NOTVICT);
                    do_simple_move(vict, attempt, true);
                } else {
                    act("$N@W is pushed away by the blast, but is slammed into an obstruction!@n", true, ch, NULL,
                        vict,
                        TO_CHAR);
                    act("@WYou are pushed away by the blast, but are slammed into an obstruction!@n", true, ch, NULL,
                        vict,
                        TO_VICT);
                    act("$N@W is pushed away by the blast, but is slammed into an obstruction!@n", true, ch, NULL,
                        vict,
        ...
        dmg = damtype(ch, 10, skill, attperc);
        dmg /= 10;
        act("@WYou fire a beam at $p@W!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a beam at $p@W!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_kiblast) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (tech_handle_android_absorb(ch, vict)) {
                    ...
                    act("@C$N@W deflects your kiblast, sending it flying away!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou deflect @C$n's@W kiblast sending it flying away!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W deflects @c$n's@W kiblast sending it flying away!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 200);
                    ...
                    act("@C$N@W moves quickly and blocks kiblast!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W kiblast!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W kiblast!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W manages to dodge your kiblast, letting it slam into the surroundings!@n", true, ch,
                        NULL,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W kiblast, letting it slam into the surroundings!@n", true, ch, NULL,
                        vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your kiblast misses, flying through the air harmlessly!@n", true,
                        ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a bright yellow kiblast at you, but misses!@n ", true, ch, NULL, vict,
                        TO_VICT);
                    act("@c$n@W fires a bright yellow kiblast at @C$N@W, but somehow misses!@n ", true, ch, NULL,
                        vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                ...
                act("@WYou can't believe it but your kiblast misses, flying through the air harmlessly!@n", true, ch,
                    NULL,
                    vict, TO_CHAR);
                act("@C$n@W fires a bright yellow kiblast at you, but misses!@n", true, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires a bright yellow kiblast at @C$N@W, but somehow misses!@n", true, ch, NULL, vict,
                    TO_NOTVICT);
                pcost(ch, attperc, 0);
            ...
            if (master_pass == true && record > GET_HIT(vict) &&
                (record - GET_HIT(vict) > (ch_getEffMaxPL(vict)) * 0.025)) {
                if (!AFF_FLAGGED(vict, AFF_KNOCKED) && !AFF_FLAGGED(vict, AFF_SANCTUARY)) {
                    act("@C$N@W is knocked out!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou are knocked out!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W is knocked out!@n", true, ch, NULL, vict, TO_NOTVICT);
                    ch_setStatusKnockedOut(vict);
                }
            }
            pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 10, skill, attperc);
        dmg /= 10;
        act("@WYou fire a kiblast at $p@W!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a kiblast at $p@W!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_slam) {
    ...
    if (!check_points(ch, 0, (ch_getEffMaxPL(ch)) / 100)) {
        return;
    }
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your slam with a punch of $S own!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W slam with a punch of your own!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W slam with a punch of $S own!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W moves quickly and blocks your slam!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W slam!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W slam!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    dmg = damtype(ch, 6, skill, attperc);
                    ...
                    act("@C$N@W manages to dodge your slam!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W slam!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W slam!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it but your slam misses!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W moves to slam you with both $s fists, but misses!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W moves to slam @C$N@W with both $s fists, but somehow misses!@n", true, ch, NULL,
                        vict,
                        TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                ...
                act("@WYou can't believe it but your slam misses!@n", true, ch, NULL, vict, TO_CHAR);
                act("@C$n@W moves to slam you with both $s fists, but misses!@n", true, ch, NULL, vict, TO_VICT);
                act("@c$n@W moves to slam @C$N@W with both $s fists, but somehow misses!@n", true, ch, NULL, vict,
                    TO_NOTVICT);
                pcost(ch, 0, stcost / 2);
            ...
            switch (hitspot) {
                ...
                case 2: /* Critical */
                    ...
                    if (ROOM_DAMAGE(IN_ROOM(vict)) <= 95 && !ROOM_FLAGGED(IN_ROOM(vict), ROOM_SPACE)) {
                        act("@W$N@W slams into the ground forming a large crater with $S body!@n", true, ch, NULL,
                            vict,
                            TO_CHAR);
                        act("@WYou slam into the ground forming a large crater with your body!@n", true, ch, NULL,
                            vict,
                            TO_VICT);
                        act("@W$N@W slams into the ground forming a large crater with $S body!@n", true, ch, NULL,
                            vict,
                            ...
                            switch (rand_number(1, 8)) {
                                ...
                                case 2:
                                    if (rand_number(1, 4) == 4 && ROOM_EFFECT(IN_ROOM(vict)) == 0) {
                                        ...
                                        act("Lava leaks up through cracks in the crater!", true, ch, NULL, vict,
                                            TO_CHAR);
                                        act("Lava leaks up through cracks in the crater!", true, ch, NULL, vict,
                                            TO_ROOM);
                                    }
                                    break;
                                case 3:
                                    act("A cloud of dust envelopes the entire area!", true, ch, NULL, vict, TO_CHAR);
                                    act("A cloud of dust envelopes the entire area!", true, ch, NULL, vict, TO_ROOM);
                                    break;
                                case 4:
                                    act("The surrounding area roars and shudders from the impact!", true, ch, NULL,
                                        vict,
                                        TO_CHAR);
                                    act("The surrounding area roars and shudders from the impact!", true, ch, NULL,
                                        vict,
                                    ...
                                    break;
                                case 5:
                                    act("The ground shatters apart from the stress of the impact!", true, ch, NULL,
                                        vict,
                                        TO_CHAR);
                                    act("The ground shatters apart from the stress of the impact!", true, ch, NULL,
                                        vict,
                        ...
                        if (SECT(IN_ROOM(vict)) == SECT_UNDERWATER) {
                            switch (rand_number(1, 3)) {
                                case 1:
                                    act("The water churns violently!", true, ch, NULL, vict, TO_CHAR);
                                    act("The water churns violently!", true, ch, NULL, vict, TO_ROOM);
                                    break;
                                case 2:
                                    act("Large bubbles rise from the movement!", true, ch, NULL, vict, TO_CHAR);
                                    act("Large bubbles rise from the movement!", true, ch, NULL, vict, TO_ROOM);
                                    break;
                                case 3:
                                    act("The water collapses in on the hole created!", true, ch, NULL, vict,
                                        TO_CHAR);
                                    act("The water collapses in on the hole create!", true, ch, NULL, vict, TO_ROOM);
                                    break;
                            }
                        }
                        if (SECT(IN_ROOM(vict)) == SECT_WATER_SWIM || SECT(IN_ROOM(vict)) == SECT_WATER_NOSWIM) {
                            switch (rand_number(1, 3)) {
                                case 1:
                                    act("A huge column of water erupts from the impact!", true, ch, NULL, vict,
                                        TO_CHAR);
                                    act("A huge column of water erupts from the impact!", true, ch, NULL, vict,
                                        TO_ROOM);
                                    break;
                                case 2:
                                    act("The impact briefly causes a swirling vortex of water!", true, ch, NULL,
                                        vict,
                                        TO_CHAR);
                                    act("The impact briefly causes a swirling vortex of water!", true, ch, NULL,
                                        vict,
                        ...
                        if (SECT(IN_ROOM(vict)) == SECT_INSIDE) {
                            ...
                            switch (rand_number(1, 8)) {
                                ...
                                case 2:
                                    ...
                                    break;
                                case 3:
                                    act("Parts of the ceiling collapse, crushing into the floor!", true, ch, NULL,
                                        vict,
                                        TO_CHAR);
                                    act("Parts of the ceiling collapse, crushing into the floor!", true, ch, NULL,
                                        vict,
                    ...
                    break;
                case 3:
                    act("@WYou fly at @C$N@W, slamming both your fists into $S gut as you fly!@n", true, ch, NULL,
                        vict,
                        TO_CHAR);
                    act("@C$n@W flies at you, slamming both $s fists into your gut as $e flies!@n", true, ch, NULL,
                        vict,
                        TO_VICT);
                    act("@c$n@W flies at @C$N@W, slamming both $s fists into $S gut as $e flies!@n", true, ch, NULL,
                        vict,
                        TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou slam both your fists into @C$N@W, hitting $M in the arm!@n", true, ch, NULL, vict,
                        TO_CHAR);
                    act("@C$n@W slams both $s fists into you, hitting you in the arm!@n", true, ch, NULL, vict,
                        TO_VICT);
                    act("@c$n@W slams both $s fists into @C$N@W, hitting $M in the arm!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    ...
                    break;
                case 5: /* Weak 2 */
                    act("@WYou slam both your fists into @C$N's@W leg!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W slams both $s fists into your leg!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W slams both $s fists into @C$N's@W leg!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou slam $p@W as hard as you can!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W slams $p@W extremely hard!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_uppercut) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your uppercut with a punch of $S own!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W uppercut with a punch of your own!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W uppercut with a punch of $S own!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W moves quickly and blocks your uppercut!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W uppercut!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W uppercut!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W manages to dodge your uppercut!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W uppercut!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W uppercut!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it but your uppercut misses!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W throws an uppercut at you but somehow misses!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W throws an uppercut at @C$N@W but somehow misses!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                ...
                act("@WYou can't believe it but your uppercut misses!@n", true, ch, NULL, vict, TO_CHAR);
                act("@C$n@W throws an uppercut at you but somehow misses!@n", true, ch, NULL, vict, TO_VICT);
                act("@c$n@W throws an uppercut at @C$N@W but somehow misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                pcost(ch, 0, stcost / 2);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou leap up and launch an uppercut into @C$N's@W body!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W leaps up and launches an uppercut into your body!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W leaps up and launches an uppercut into @C$N's@W body!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou smash an uppercut into @C$N's@W chin!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W smashes an uppercut into your chin!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W smashes an uppercut into @C$N's@W chin!@n", true, ch, NULL, vict, TO_NOTVICT);
                    if (!AFF_FLAGGED(vict, AFF_KNOCKED) &&
                    ...
                    break;
                case 3:
                    act("@WYou uppercut @C$N@W, hitting $M directly in chest!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W uppercuts you, hitting you directly in the chest!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W uppercuts @C$N@W, hitting $M directly in the chest!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYour poorly aimed uppercut hits @C$N@W in the arm!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W poorly aims an uppercut and hits you in the arm!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W poorly aims an uppercut and hits @C$N@W in the arm!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 195, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    ...
                    break;
                case 5: /* Weak 2 */
                    act("@WYou slam an uppercut into @C$N's@W leg!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W slams an uppercut into your leg!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W slams an uppercut into @C$N's@W leg!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(1, 195, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou uppercut $p@W as hard as you can!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W uppercuts $p@W extremely hard!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_tailwhip) {
    ...
    if (!check_points(ch, 0, (ch_getEffMaxPL(ch)) / 120)) {
        return;
    }
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your tailwhip with a punch of $S own!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W tailwhip with a punch of your own!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W tailwhip with a punch of $S own!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W moves quickly and blocks your tailwhip!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W tailwhip!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W tailwhip!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W manages to dodge your tailwhip!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W tailwhip!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W tailwhip!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it but your tailwhip misses!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W throws a tailwhip at you but somehow misses!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W throws a tailwhip at @C$N@W but somehow misses!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                ...
                act("@WYou can't believe it but your tailwhip misses!@n", true, ch, NULL, vict, TO_CHAR);
                act("@C$n@W throws a tailwhip at you but somehow misses!@n", true, ch, NULL, vict, TO_VICT);
                act("@c$n@W throws a tailwhip at @C$N@W but somehow misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                pcost(ch, 0, stcost / 2);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou spin to swing your tail and slam it into @c$N@W's body!@n", true, ch, NULL, vict,
                        TO_CHAR);
                    act("@C$n@W spins to swing $s tail and slams it into YOUR body!@n", true, ch, NULL, vict,
                        TO_VICT);
                    act("@C$n@W spins to swing $s tail and slams it into @c$N@W's body!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                ...
                case 2: /* Critical */
                    ...
                    break;
                case 3:
                    act("@WYou swing your tail and manage to slam it into @c$N@W's gut!@n", true, ch, NULL, vict,
                        TO_CHAR);
                    act("@C$n@W swings $s tail and manages to slam it into YOUR gut!@n", true, ch, NULL, vict,
                        TO_VICT);
                    act("@C$n@W swings $s tail and manages to slam it into @c$N@W's gut!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    if (!AFF_FLAGGED(vict, AFF_FLYING) && GET_POS(vict) == POS_STANDING && rand_number(1, 8) >= 7) {
                        handle_knockdown(vict);
                    }
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou swing your tail and manage to slam it into @c$N@W's arm!@n", true, ch, NULL, vict,
                        TO_CHAR);
                    act("@C$n@W swings $s tail and manages to slam it into YOUR arm!@n", true, ch, NULL, vict,
                        TO_VICT);
                    act("@C$n@W swings $s tail and manages to slam it into @c$N@W's arm!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 195, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    ...
                    break;
                case 5: /* Weak 2 */
                    act("@WYou swing your tail and manage to slam it into @c$N@W's leg!@n", true, ch, NULL, vict,
                        TO_CHAR);
                    act("@C$n@W swings $s tail and manages to slam it into YOUR leg!@n", true, ch, NULL, vict,
                        TO_VICT);
                    act("@C$n@W swings $s tail and manages to slam it into @c$N@W's leg!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(1, 195, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou tailwhip $p@W as hard as you can!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W tailwhips $p@W extremely hard!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_roundhouse) {
    ...
    if (!limb_ok(ch, 1)) {
        ...
        if (GET_LIMBCOND(ch, 3) < 0) {
            act("@RYour right leg has fallen apart!@n", true, ch, NULL, NULL, TO_CHAR);
            act("@r$n@R's right leg has fallen apart!@n", true, ch, NULL, NULL, TO_ROOM);
        }
        ...
        if (GET_LIMBCOND(ch, 4) < 0) {
            act("@RYour left leg has fallen apart!@n", true, ch, NULL, NULL, TO_CHAR);
            act("@r$n@R's left leg has fallen apart!@n", true, ch, NULL, NULL, TO_ROOM);
        }
    }
    ...
    if (!check_points(ch, 0, (ch_getEffMaxPL(ch)) / 180)) {
        return;
    }
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your roundhouse with a punch of $S own!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W roundhouse with a punch of your own!@n", true, ch, NULL, vict,
                        TO_VICT);
                    act("@C$N@W parries @c$n's@W roundhouse with a punch of $S own!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W moves quickly and blocks your roundhouse!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W roundhouse!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W roundhouse!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W manages to dodge your roundhouse!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W roundhouse!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W roundhouse!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it but your roundhouse misses!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W throws a roundhouse at you but somehow misses!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W throws a roundhouse at @C$N@W but somehow misses!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                ...
                act("@WYou can't believe it but your roundhouse misses!@n", true, ch, NULL, vict, TO_CHAR);
                act("@C$n@W throws a roundhouse at you but somehow misses!@n", true, ch, NULL, vict, TO_VICT);
                act("@c$n@W throws a roundhouse at @C$N@W but somehow misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                pcost(ch, 0, stcost / 2);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou spin in mid air and land a kick into @C$N's@W body!@n", true, ch, NULL, vict,
                        TO_CHAR);
                    act("@C$n@W spins in mid air and lands a kick into your body!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W spins in mid air and lands a kick into @C$N's@W body!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou spin a fierce roundhouse into @C$N's@W gut!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W spins a fierce roundhouse into your gut!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W spins a fierce roundhouse into @C$N's@W gut!@n", true, ch, NULL, vict, TO_NOTVICT);
                    if (!AFF_FLAGGED(vict, AFF_FLYING) && GET_POS(vict) == POS_STANDING && rand_number(1, 8) >= 7) {
                        handle_knockdown(vict);
                    }
                    dmg *= calc_critical(ch, 0);
                    ...
                    break;
                case 3:
                    act("@WYou throw a roundhouse at @C$N@W, hitting $M directly in the neck!@n", true, ch, NULL,
                        vict,
                        TO_CHAR);
                    act("@C$n@W throws a roundhouse at you, hitting YOU directly in the neck!@n", true, ch, NULL,
                        vict,
                        TO_VICT);
                    act("@c$n@W throws a roundhouse at @C$N@W, hitting $M directly in the face!@n", true, ch, NULL,
                        vict,
                        TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYour poorly aimed roundhouse hits @C$N@W in the arm!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W poorly aims a roundhouse and hits you in the arm!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W poorly aims a roundhouse and hits @C$N@W in the arm!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 195, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    ...
                    break;
                case 5: /* Weak 2 */
                    act("@WYou slam a roundhouse into @C$N's@W leg!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W slams a roundhouse into your leg!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W slams a roundhouse into @C$N's@W leg!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(1, 195, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou roundhouse $p@W as hard as you can!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W roundhouses $p@W extremely hard!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_elbow) {
    ...
    if (!check_points(ch, 0, (ch_getEffMaxPL(ch)) / 300)) {
        return;
    }
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your elbow with an elbow of $S own!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W elbow with one of your own!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W elbow with an elbow of $S own!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W blocks your elbow strike!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou block @C$n's@W elbow strike!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W blocks @c$n's@W elbow strike!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W dodges your elbow strike!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W elbow strike!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W dodges @c$n's@W elbow strike!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it, your elbow strike misses!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W throws an elbow strike at you, but thankfully misses!@n", true, ch, NULL, vict,
                        TO_VICT);
                    act("@c$n@W throws an elbow strike at @C$N@W, but misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                ...
                act("@WYou can't believe it, your elbow strike misses!@n", true, ch, NULL, vict, TO_CHAR);
                act("@C$n@W throws an elbow stike at you, but thankfully misses!@n", true, ch, NULL, vict, TO_VICT);
                act("@c$n@W throws an elbow strike at @C$N@W, but misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou slam your elbow into @C$N's@W body!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W slams $s elbow into your body!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W slams $s elbow into @C$N's@W body!@n", true, ch, NULL, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou slam your elbow into @C$N's@W face!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W slams $s elbow into your face!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W slams $s elbow into @C$N's@W face!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 3);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 3:
                    act("@WYou land your elbow against @C$N's@W gut!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W lands $s elbow against your gut!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$n@W lands $s elbow against @C$N's@W gut!@n", true, ch, NULL, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou land your elbow against @C$N's@W leg!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W lands $s elbow against your leg!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$n@W lands $s elbow against @C$N's@W leg!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak */
                    act("@WYou land your elbow against @C$N's@W arm!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W lands $s elbow against your arm!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$n@W lands $s elbow against @C$N's@W arm!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou elbow stike $p@W as hard as you can!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W elbow strikes $p@W extremely hard!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_kick) {
    ...
    if (!check_points(ch, 0, (ch_getEffMaxPL(ch)) / 400)) {
        return;
    }
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your kick with a kick of $S own!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W kick with one of your own!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W kick with a kick of $S own!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W blocks your kick!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou block @C$n's@W kick!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W blocks @c$n's@W kick!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    dmg = damtype(ch, 1, skill, attperc);
                    ...
                    act("@C$N@W dodges your kick!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W kick!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W dodges @c$n's@W kick!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it, your kick misses!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W throws a kick at you, but thankfully misses!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W throws a kick at @C$N@W, but misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou slam your foot into @C$N's@W body!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W slams $s foot into your body!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W slams $s foot into @C$N's@W body!@n", true, ch, NULL, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou slam your foot into @C$N's@W face!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W slams $s foot into your face!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W slams $s foot into @C$N's@W face!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 3);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 3:
                    act("@WYou land your foot against @C$N's@W gut!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W lands $s foot against your gut!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$n@W lands $s foot against @C$N's@W gut!@n", true, ch, NULL, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou land your foot against @C$N's@W leg!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W lands $s foot against your leg!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$n@W lands $s foot against @C$N's@W leg!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak */
                    act("@WYou land your foot against @C$N's@W arm!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W lands $s foot against your arm!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$n@W lands $s foot against @C$N's@W arm!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou kick $p@W as hard as you can!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W kicks $p@W extremely hard!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_knee) {
    ...
    if (!check_points(ch, 0, (ch_getEffMaxPL(ch)) / 250)) {
        return;
    }
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your knee with a knee of $S own!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W knee with one of your own!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W knee with a knee of $S own!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W blocks your knee strike!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou block @C$n's@W knee strike!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W blocks @c$n's@W knee strike!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    dmg = damtype(ch, 3, skill, attperc);
                    ...
                    act("@C$N@W dodges your knee strike!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W knee strike!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W dodges @c$n's@W knee strike!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it, your knee strike misses!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W throws a knee strike at you, but thankfully misses!@n", true, ch, NULL, vict,
                        TO_VICT);
                    act("@c$n@W throws a knee strike at @C$N@W, but misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                ...
                act("@WYou can't believe it, your  knee strike misses!@n", true, ch, NULL, vict, TO_CHAR);
                act("@C$n@W throws a knee stike at you, but thankfully misses!@n", true, ch, NULL, vict, TO_VICT);
                act("@c$n@W throws a knee strike at @C$N@W, but misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou slam your knee into @C$N's@W body!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W slams $s knee into your body!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W slams $s knee into @C$N's@W body!@n", true, ch, NULL, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou slam your knee into @C$N's@W face!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W slams $s knee into your face!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W slams $s knee into @C$N's@W face!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 3);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 3:
                    act("@WYou land your knee against @C$N's@W gut!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W lands $s knee against your gut!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$n@W lands $s knee against @C$N's@W gut!@n", true, ch, NULL, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou land your knee against @C$N's@W leg!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W lands $s knee against your leg!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$n@W lands $s knee against @C$N's@W leg!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak */
                    act("@WYou land your knee against @C$N's@W arm!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W lands $s knee against your arm!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$n@W lands $s knee against @C$N's@W arm!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou knee stike $p@W as hard as you can!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W knee strikes $p@W extremely hard!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_punch) {
    ...
    if (!check_points(ch, 0, (ch_getEffMaxPL(ch)) / 500)) {
        return;
    }
    skill = init_skill(ch, SKILL_PUNCH);
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your punch with a punch of $S own!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W punch with a punch of your own!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W punch with a punch of $S own!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W moves quickly and blocks your punch!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W punch!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W punch!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    dmg = damtype(ch, 0, skill, attperc);
                    ...
                    act("@C$N@W manages to dodge your punch!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W punch!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W punch!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it but your punch misses!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W throws a punch at you but somehow misses!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W throws a punch at @C$N@W but somehow misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou slam your fist into @C$N's@W body!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W slams $s fist into your body!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W slams $s fist into @C$N's@W body!@n", true, ch, NULL, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou slam your fist into @C$N's@W face!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W slams $s fist into your face!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W slams $s fist into @C$N's@W face!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 3);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 3:
                    act("@WYou punch @C$N@W directly in the gut!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W punches you directly in the gut!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W punches @C$N@W directly in the gut!@n", true, ch, NULL, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou punch @C$N@W in the arm!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W punches you in the arm!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W punches @C$N@W in the arm!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak 2 */
                    act("@WYou punch @C$N@W in the leg!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W punches you in the leg!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W punches @C$N@W in the arm!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou punch $p@W as hard as you can!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W punches $p@W extremely hard!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_charge) {
    ...
    if (!*arg) {
        ...
        switch (rand_number(1, 3)) {
            case 1:
                act("$n@w's aura disappears.@n", true, ch, NULL, NULL, TO_ROOM);
                break;
            case 2:
                act("$n@w's aura fades.@n", true, ch, NULL, NULL, TO_ROOM);
                break;
            case 3:
                act("$n@w's aura flickers brightly before disappearing.@n", true, ch, NULL, NULL, TO_ROOM);
                break;
            default:
                act("$n@w's aura disappears.@n", true, ch, NULL, NULL, TO_ROOM);
                break;
        ...
        int64_t result1;
        result1 = ch_incCurKI(ch, GET_CHARGE(ch), true);
        GET_CHARGE(ch) = 0;
        GET_CHARGETO(ch) = 0;
        ...
        if (((ch_getMaxKI(ch) * ch->energy)) < GET_MAX_MANA(ch) / 100) {
            ...
            if (amt >= 101) {
                ...
                int64_t diff = 0;
                if ((ch_getCurKI(ch)) < ((GET_MAX_MANA(ch) * 0.01) * amt) + 1) {
                    diff = (((GET_MAX_MANA(ch) * 0.01) * amt) + 1) - (ch_getCurKI(ch));
                }
                int chance = 15;
                ...
                if (chance > rand_number(1, 100)) {
                    ...
                    act(bloom, true, ch, NULL, NULL, TO_ROOM);
                    GET_CHARGE(ch) = (((GET_MAX_MANA(ch) * 0.01) * amt) + 1) - diff;
                    int64_t amt1 = (((GET_MAX_MANA(ch) * 0.01) * amt) + 1) - diff + spiritcost;
                    int64_t result;
                    result = ch_decCurKI(ch, amt1, 0);
                }
            } else {
                reveal_hiding(ch, 0);
...
ACMD(do_powerup) {
    if (IS_NPC(ch)) {
        ...
        if ((ch_getEffMaxPL(ch)) < 50000) {
            act("@RYou begin to powerup, and air billows outward around you!@n", true, ch, NULL, NULL, TO_CHAR);
            act("@R$n begins to powerup, and air billows outward around $m!@n", true, ch, NULL, NULL, TO_ROOM);
        } else if ((ch_getEffMaxPL(ch)) < 500000) {
            act("@RYou begin to powerup, and loose objects are lifted into the air!@n", true, ch, NULL, NULL,
                TO_CHAR);
            act("@R$n begins to powerup, and loose objects are lifted into the air!@n", true, ch, NULL, NULL,
                TO_ROOM);
        } else if ((ch_getEffMaxPL(ch)) < 5000000) {
            act("@RYou begin to powerup, and torrents of energy crackle around you!@n", true, ch, NULL, NULL,
                TO_CHAR);
            act("@R$n begins to powerup, and torrents of energy crackle around $m!@n", true, ch, NULL, NULL,
                TO_ROOM);
        } else if ((ch_getEffMaxPL(ch)) < 50000000) {
            act("@RYou begin to powerup, and the entire area begins to shudder!@n", true, ch, NULL, NULL,
                TO_CHAR);
            act("@R$n begins to powerup, and the entire area begins to shudder!@n", true, ch, NULL, NULL,
                TO_ROOM);
        } else if ((ch_getEffMaxPL(ch)) < 100000000) {
            act("@RYou begin to powerup, and massive cracks begin to form beneath you!@n", true, ch, NULL, NULL,
                TO_CHAR);
            act("@R$n begins to powerup, and massive cracks begin to form beneath $m!@n", true, ch, NULL, NULL,
                TO_ROOM);
        } else if ((ch_getEffMaxPL(ch)) < 300000000) {
            act("@RYou begin to powerup, and everything around you shudders from the power!@n", true, ch, NULL,
                NULL,
                TO_CHAR);
            act("@R$n begins to powerup, and everything around $m shudders from the power!@n", true, ch, NULL,
                NULL, TO_ROOM);
        } else {
            act("@RYou begin to powerup, and the very air around you begins to burn!@n", true, ch, NULL, NULL,
                TO_CHAR);
            act("@R$n begins to powerup, and the very air around $m begins to burn!@n", true, ch, NULL, NULL,
                TO_ROOM);
        }
        return;
    }
    ...
    if (GET_HIT(ch) >= (ch_getEffMaxPL(ch))) {
        send_to_char(ch, "@WYou are already at max!@n");
        return;
    }
    if (((ch_getMaxKI(ch) * ch->energy)) < GET_MAX_MANA(ch) / 20) {
...
ACMD(do_rescue) {
    ...
    if (!*arg)
        ...
        if (GET_SPEEDI(ch) + mobbonus < GET_SPEEDI(opponent) && rand_number(1, 3) != 3) {
            act("@GYou leap towards @g$N@G and try to rescue $M but are too slow!@n", true, ch, NULL, helpee,
                TO_CHAR);
            act("@g$n@G leaps towards you! $n is too slow and fails to rescue you!@n", true, ch, NULL, helpee,
                TO_VICT);
            act("@g$n@G leaps towards @g$N@G and tries to rescue $M but is too slow!@n", true, ch, NULL, helpee,
                TO_NOTVICT);
            return;
        }
        act("@GYou leap in front of @g$N@G and rescue $M!@n", true, ch, NULL, helpee, TO_CHAR);
        act("@g$n@G leaps in front of you! You are rescued!@n", true, ch, NULL, helpee, TO_VICT);
        act("@g$n@G leaps in front of @g$N@G and rescues $M!@n", true, ch, NULL, helpee, TO_NOTVICT);
...
ACMD(do_assist) {
     ...
     */
        ...
        if (!opponent)
            act("But nobody is fighting $M!", true, ch, NULL, helpee, TO_CHAR);
        else if (!CAN_SEE(ch, opponent))
            act("You can't see who is fighting $M!", true, ch, NULL, helpee, TO_CHAR);
            /* prevent accidental pkill */
        else {
            reveal_hiding(ch, 0);
            send_to_char(ch, "You join the fight!\r\n");
            act("$N assists you!", 0, helpee, NULL, ch, TO_CHAR);
            act("$n assists $N.", true, ch, NULL, helpee, TO_NOTVICT);
            if (!FIGHTING(ch)) {
...
ACMD(do_kill) {
    ...
    if (!*arg) {
        ...
        if (!(vict = get_char_vis(ch, arg, NULL, FIND_CHAR_ROOM)))
            ...
            act("You chop $M to pieces!  Ah!  The blood!", true, ch, NULL, vict, TO_CHAR);
            act("$N chops you to pieces!", true, vict, NULL, ch, TO_CHAR);
            act("$n brutally slays $N!", true, ch, NULL, vict, TO_NOTVICT);
            raw_kill(vict, ch);
        }
    }
}
        ...
        if (CAN_GO(ch, attempt) &&
            ...
            if (ABSORBBY(ch)) {
                if (axion_dice(0) < GET_SKILL(ABSORBING(ch), SKILL_ABSORB)) {
                    ...
                    act("@c$N@W manages to break loose of @C$n's@W hold!@n", true, ABSORBBY(ch), NULL, ch,
                        TO_NOTVICT);
                    act("@WYou manage to break loose of @C$n's@W hold!@n", true, ABSORBBY(ch), NULL, ch, TO_VICT);
                    act("@c$N@W manages to break loose of your hold!@n", true, ABSORBBY(ch), NULL, ch, TO_CHAR);
