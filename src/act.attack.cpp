...
ACMD(do_lightgrenade) {
    ...
    if (skill < perc) {
        ...
        act("@C$n@W quickly brings $s hands in front of $s body and cups them a short distance from each other. A flash of @Ggreen @Ylight@W can be seen as ki is condensed between $s hands before a @Yg@yo@Yl@yd@Ye@yn@W orb of ki replaces the green light. Suddenly $s concentration seems to waiver and the energy slips away from $s control harmlessly!@n",
            true, ch, NULL, targ, TO_VICT);
        act("@C$n@W quickly brings $s hands in front of $s body and cups them a short distance from each other. A flash of @Ggreen @Ylight@W can be seen as ki is condensed between $s hands before a @Yg@yo@Yl@yd@Ye@yn@W orb of ki replaces the green light. Suddenly $s concentration seems to waiver and the energy slips away from $s control harmlessly!@n",
            true, ch, NULL, targ, TO_NOTVICT);
        pcost(ch, attperc, 0);
    ...
    for (vict = world[IN_ROOM(ch)].people; vict; vict = next_v) {
        ...
        if (((!IS_NPC(vict) && IS_ICER(vict) && rand_number(1, 30) >= 28) || AFF_FLAGGED(vict, AFF_ZANZOKEN)) &&
            ...
            act("@C$N@c disappears, avoiding the explosion before reappearing elsewhere!@n", false, ch, NULL, vict,
                TO_CHAR);
            ...
            act("@c$N@W manages to dodge the light grenade!@n", true, ch, NULL, vict, TO_CHAR);
            act("@WYou manages to dodge the light grenade!@n", true, ch, NULL, vict, TO_VICT);
            act("@c$N@W manages to dodge the light grenade!@n", true, ch, NULL, vict, TO_NOTVICT);
            ...
            act("@R$N@r is hit by the light grenade which explodes all around $m!@n", true, ch, NULL, vict, TO_CHAR);
            act("@RYou are hit by the light grenade which explodes all around you!@n", true, ch, NULL, vict,
                TO_VICT);
            act("@R$N@r is hit by the light grenade which explodes all around $m!@n", true, ch, NULL, vict,
                TO_NOTVICT);
            ...
            act("@R$N@r is caught by the light grenade's explosion!@n", true, ch, NULL, vict, TO_CHAR);
            act("@RYou are caught by the light grenade's explosion!@n", true, ch, NULL, vict, TO_VICT);
            act("@R$N@r is caught by the light grenade's explosion!@n", true, ch, NULL, vict, TO_NOTVICT);
            if (!AFF_FLAGGED(vict, AFF_FLYING) && GET_POS(vict) == POS_STANDING && rand_number(1, 4) == 4) {
                handle_knockdown(vict);
            }
...
ACMD(do_breath) {
    ...
    int64_t dmg, stcost = (ch_getEffMaxPL(ch)) / 5000;
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@WYou move quickly and block @C$n's@W fiery breath!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W fiery breath!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    ...
                    act("@WYou dodge the fiery jets of flames coming from @C$n's@W mouth!@n", true, ch, NULL, vict,
                        TO_VICT);
                    ...
                    act("@C$n@W moves to breath flames on you, but misses!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W moves to breath flames on @C$N@W, but somehow misses!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
        ...
        act("@C$n@W breathes flames on $p@W!@n", true, ch, obj, NULL, TO_ROOM);
...
ACMD(do_ram) {
    int prob, perc, avo, index = 0, pry = 2, dge = 2, blk = 2, skill = 0;
    int64_t dmg, stcost = (ch_getEffMaxPL(ch)) / 200;
    struct char_data *vict;
    struct obj_data *obj;
    char arg[MAX_INPUT_LENGTH];
    double attperc = 0;
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > axion_dice(10)) {
                    act("@WYou move quickly and block @C$n's@W body as $e tries to ram YOU!@n", true, ch, NULL, vict,
                        TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W body as $e tries to ram $M!@n", true, ch, NULL,
                        vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@WYou dodge @C$n's@W attempted ram!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W attempted ram!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@C$n@W moves to ram you, but misses!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W moves to ram @C$N@W, but somehow misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@C$n@W aims $s body at YOU and rams into YOUR body!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W aims $s body at @C$N@W and rams into $S body!@n", true, ch, NULL, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@C$n@W aims $s body at YOU and rams into YOUR face!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W aims $s body at @C$N@W and rams into $S face!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 4);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                ...
                case 3:
                    ...
                    break;
                case 4: /* Weak */
                    act("@C$n@W aims $s body at YOU and rams into YOUR arm!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W aims $s body at @C$N@W and rams into $S arm!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    ...
                    break;
                case 5: /* Weak 2 */
                    act("@C$n@W aims $s body at YOU and rams into YOUR leg!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W aims $s body at @C$N@W and rams into $S leg!@n", true, ch, NULL, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@C$n@W rams $p@W extremely hard!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_strike) {
    int prob, perc, avo, index = 0, pry = 2, dge = 2, blk = 2, skill = 0;
    int64_t dmg, stcost = (ch_getEffMaxPL(ch)) / 400;
    struct char_data *vict;
    struct obj_data *obj;
    char arg[MAX_INPUT_LENGTH];
    double attperc = 0;
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@WYou parry @C$n's@W fang strike with a punch of your own!@n", true, ch, NULL, vict,
                        TO_VICT);
                    act("@C$N@W parries @c$n's@W fang strike with a punch of $S own!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    ...
                    act("@WYou move quickly and block @C$n's@W fang strike!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W fang strike!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    dmg = damtype(ch, 6, skill, attperc);
                    ...
                    act("@WYou dodge @C$n's@W fang strike!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W fang strike!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@C$n@W moves to fang strike you, but misses!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W moves to fang strike @C$N@W, but somehow misses!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                ...
                act("@C$n@W moves to fang strike you, but misses!@n", true, ch, NULL, vict, TO_VICT);
                act("@c$n@W moves to fang strike @C$N@W, but somehow misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                pcost(ch, 0, stcost / 2);
            ...
            switch (hitspot) {
                case 1:
                    act("@C$n@W launches $s body at YOU and sinks $s fang strike into YOUR body!@n", true, ch, NULL,
                        vict, TO_VICT);
                    act("@c$n@W launches $s body at @C$N@W and sinks $s fang strike into $S body!@n", true, ch, NULL,
                        vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    ...
                    break;
                case 2: /* Critical */
                    act("@C$n@W launches $s body at YOU and sinks $s fang strike into YOUR face!@n", true, ch, NULL,
                        vict, TO_VICT);
                    act("@c$n@W launches $s body at @C$N@W and sinks $s fang strike into $S face!@n", true, ch, NULL,
                        vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 4);
                ...
                case 3:
                    ...
                    break;
                case 4: /* Weak */
                    act("@C$n@W launches $s body at YOU and sinks $s fang strike into YOUR arm!@n", true, ch, NULL,
                        vict, TO_VICT);
                    act("@c$n@W launches $s body at @C$N@W and sinks $s fang strike into $S arm!@n", true, ch, NULL,
                        vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 1);
                    ...
                    break;
                case 5: /* Weak 2 */
                    act("@C$n@W launches $s body at YOU and sinks $s fang strike into YOUR leg!@n", true, ch, NULL,
                        vict, TO_VICT);
                    act("@c$n@W launches $s body at @C$N@W and sinks $s fang strike into $S leg!@n", true, ch, NULL,
                        vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, NULL, dmg, 0);
                    dam_eq_loc(vict, 2);
            ...
            pcost(ch, 0, stcost);
            int64_t result;
            result = ch_decCurST(vict, dmg * .25, 0);
            return;
        }
    } else if (obj) {
        if (!can_kill(ch, NULL, obj, 0)) {
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@C$n@W fang strikes $p@W extremely hard!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_sunder) {
    ...
    if (vict) {
            ...
            if (((ch_getCurST(vict))) > 0) {
                if (dge > rand_number(1, 130)) {
                    act("@C$N@W manages to dodge your Sundering Force, letting it fly harmlessly by!@n", false, ch,
                        NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Sundering Force, letting it fly harmlessly by!@n", false, ch, NULL,
                        vict, TO_VICT);
                    ...
                    act("@C$n@W fires a Sundering Force at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a Sundering Force at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
        ...
        dmg /= 10;
        act("@WYou fire a Sundering Force at $p@W!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a Sundering Force at $p@W!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    } else {
        send_to_char(ch, "Error! Please report.\r\n");
...
ACMD(do_zen) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > rand_number(1, 130)) {
                    act("@C$N@W moves quickly and blocks your Zen Blade Strike!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Zen Blade Strike!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Zen Blade Strike!@n", false, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_ZEN) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                    ...
                    act("@WYou can't believe it but your Zen Blade Strike misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a Zen Blade Strike at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a Zen Blade Strike at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
        ...
        dmg /= 10;
        act("@WYou fire a Zen Blade Strike at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a Zen Blade Strike at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_malice) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > rand_number(1, 130)) {
                    act("@C$N@W moves quickly and blocks your Malice Breaker!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Malice Breaker!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Malice Breaker!@n", false, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@WYou can't believe it but your Malice Breaker misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a Malice Breaker at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a Malice Breaker at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
        ...
        dmg = damtype(ch, 36, skill, attperc);
        dmg /= 10;
        act("@WYou fire a Malice Breaker at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a Malice Breaker at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
...
ACMD(do_head) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your headbutt with an attack of $S own!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W headbutt with an attack of your own!@n", true, ch, NULL, vict,
                        TO_VICT);
                    act("@C$N@W parries @c$n's@W headbutt with an attack of $S own!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W blocks your headbutt!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou block @C$n's@W headbutt!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W blocks @c$n's@W headbutt!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W dodges your headbutt!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W headbutt!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W dodges @c$n's@W headbutt!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it, your headbutt misses!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W throws a headbutt at you, but thankfully misses!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W throws a headbutt at @C$N@W, but misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou grab @c$N@W by the shoulders and slam your head into $S chest!@n", true, ch, NULL,
                        vict, TO_CHAR);
                    act("@C$n@W grabs YOU by the shoulders and slams $s head into YOUR chest!@n", true, ch, NULL,
                        vict, TO_VICT);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou grab @c$N@W by the shoulders and slam your head into $S face!@n", true, ch, NULL,
                        vict, TO_CHAR);
                    act("@C$n@W grabs YOU by the shoulders and slams $s head into YOUR face!@n", true, ch, NULL,
                        vict, TO_VICT);
                ...
                case 3:
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou grab @c$N@W and barely manage to slam your head into $S leg!@n", true, ch, NULL, vict,
                        TO_CHAR);
                    act("@C$n@W grabs YOU and barely manages to slam $s head into YOUR leg!@n", true, ch, NULL, vict,
                        TO_VICT);
                    ...
                    break;
                case 5: /* Weak */
                    act("@WYou grab @c$N@W and barely manage to slam your head into $S arm!@n", true, ch, NULL, vict,
                        TO_CHAR);
                    act("@C$n@W grabs YOU and barely manages to slam $s head into YOUR arm!@n", true, ch, NULL, vict,
                        TO_VICT);
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou headbutt $p@W as hard as you can!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W headbutt $p@W extremely hard!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_bash) {
    ...
    if (!check_points(ch, 0, (ch_getEffMaxPL(ch)) / 70)) {
        return;
    }
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your bash with an attack of $S own!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W bash with an attack of your own!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W bash with an attack of $S own!@n", true, ch, NULL, vict,
                        TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    ...
                    act("@C$N@W blocks your bash!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou block @C$n's@W bash!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W blocks @c$n's@W bash!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, (ch_getEffMaxPL(vict)) / 500);
                    dmg = damtype(ch, 3, skill, attperc);
                    ...
                    act("@C$N@W dodges your bash!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W bash!@n", true, ch, NULL, vict, TO_VICT);
                    act("@C$N@W dodges @c$n's@W bash!@n", true, ch, NULL, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
                    ...
                    act("@WYou can't believe it, your bash misses!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W throws a bash at you, but thankfully misses!@n", true, ch, NULL, vict, TO_VICT);
                    act("@c$n@W throws a bash at @C$N@W, but misses!@n", true, ch, NULL, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, NULL, 0, 0);
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou bash $p@W as hard as you can!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W bash $p@W extremely hard!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_seishou) {
    ...
    if (vict) {
            ...
            if (((ch_getCurST(vict))) > 0) {
                if (dge > rand_number(1, 130)) {
                    act("@C$N@W manages to dodge your Seishou Enko, letting it fly harmlessly by!@n", false, ch,
                        NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Seishou Enko, letting it fly harmlessly by!@n", false, ch, NULL, vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your Seishou Enko misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a Seishou Enko at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a Seishou Enko at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc / 4, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
        ...
        dmg = damtype(ch, 10, skill, attperc);
        dmg /= 10;
        act("@WYou fire a Seishou Enko at $p@W!@n", true, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires a Seishou Enko at $p@W!@n", true, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    } else {
        send_to_char(ch, "Error! Please report.\r\n");
...
ACMD(do_throw) {
    ...
    if (obj) {
        ...
        if (((ch_getCurST(ch))) < (((ch_getEffMaxPL(ch)) / 200) + GET_OBJ_WEIGHT(obj))) {
        ...
        if (GET_OBJ_WEIGHT(obj) + ROOM_GRAVITY(IN_ROOM(ch)) > CAN_CARRY_W(ch)) {
            ...
            damage = ((GET_OBJ_WEIGHT(obj) / 3) * (GET_STR(ch)) * (GET_CHA(ch) / 3)) + ((ch_getEffMaxPL(ch)) * 0.01);
            ...
            if (GET_OBJ_TYPE(obj) == ITEM_WEAPON) {
                if (GET_OBJ_VAL(obj, VAL_WEAPON_DAMTYPE) == TYPE_PIERCE - TYPE_HIT) {
                    ...
                    wtype = 5;
                    damage = ((GET_OBJ_WEIGHT(obj) * GET_STR(ch)) * (GET_CHA(ch) / 3)) + ((ch_getEffMaxPL(ch)) * 0.01);
            ...
            if (!tech_handle_zanzoken(ch, vict, "$p")) {
                COMBO(ch) = -1;
                COMBHITS(ch) = 0;
                int stcost = (((ch_getEffMaxPL(ch)) / 200) + GET_OBJ_WEIGHT(obj));
                REMOVE_BIT_AR(AFF_FLAGS(vict), AFF_ZANZOKEN);
                pcost(ch, 0, stcost / 2);
                pcost(vict, 0, (ch_getEffMaxPL(vict)) / 200);
                obj_from_char(obj);
            ...
            if (perc - (perc2 / 10) < prob) {
                if (OBJ_FLAGGED(obj, ITEM_ICE) && IS_DEMON(vict)) {
                    ...
                    int64_t amt = (((ch_getEffMaxPL(ch)) / 100) + GET_OBJ_WEIGHT(obj));
                    int64_t result;
                ...
                int64_t amt1 = (((ch_getEffMaxPL(ch)) / 100) + GET_OBJ_WEIGHT(obj));
                int64_t result1;
                ...
                obj_from_char(obj);
                obj_to_room(obj, IN_ROOM(vict));
                int64_t amt2 = (((ch_getEffMaxPL(ch)) / 200) + GET_OBJ_WEIGHT(obj));
                int64_t result2;
                result2 = ch_decCurST(ch, amt2, 0);
            ...
            if (!IS_NPC(ch) && PRF_FLAGGED(ch, PRF_ENERGIZE) && ((ch_getMaxKI(ch) * ch->energy)) >= GET_MAX_MANA(ch) * 0.02) {
                ...
                if (GET_MAX_MANA(ch) * 0.02 > 0) {
                    int64_t amt = ch_getMaxKI(ch) * .02;
                    int64_t result;
                    result = ch_decCurKI(ch, amt, 0);
                } else {
                    int64_t result;
                    result = ch_decCurKI(ch, 1, 0);
                }
            ...
            if ((GET_OBJ_VAL(obj, VAL_ALL_HEALTH) - odam) <= 0 && !OBJ_FLAGGED(obj, ITEM_UNBREAKABLE)) {
                ...
                if (IS_ANDROID(vict) || IS_MECHANICAL(vict)) {
                    act("@RSome pieces of metal are sent flying!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@RSome pieces of metal are sent flying!@n", true, ch, NULL, vict, TO_VICT);
                    act("@RSome pieces of metal are sent flying!@n", true, ch, NULL, vict, TO_NOTVICT);
                } else if (IS_MAJIN(vict)) {
                    act("@RA wide hole is left in $S gooey flesh!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@RA wide hole is left is your gooey flesh!@n", true, ch, NULL, vict, TO_VICT);
                    act("@RA wide hole is left in $N@R's gooey flesh@n", true, ch, NULL, vict, TO_NOTVICT);
                } else {
                    act("@RBlood flies out from the impact!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@RBlood flies out from the impact!@n", true, ch, NULL, vict, TO_VICT);
                    act("@RBlood flies out from the impact!@n", true, ch, NULL, vict, TO_NOTVICT);
                }
                if (OBJ_FLAGGED(obj, ITEM_ICE)) {
                    if (!IS_ANDROID(vict) && !IS_ICER(vict)) {
                        int64_t amt = (ch_getMaxST(vict) * .005) + GET_OBJ_WEIGHT(obj);
                        int64_t result;
                        result = ch_decCurST(vict, amt, 0);
                        act("@mYou lose some stamina to the @ccold@m!@n", true, ch, NULL, vict, TO_VICT);
                        act("@C$N@m loses some stamina to the @ccold@m!@n", true, ch, NULL, vict, TO_CHAR);
                        act("@C$N@m loses some stamina to the @ccold@m!@n", true, ch, NULL, vict, TO_NOTVICT);
                    }
                }
            ...
            if (hot == true) {
                if (!IS_DEMON(vict) && !GET_BONUS(vict, BONUS_FIREPROOF)) {
                    act("@R$N@R is burned by it!@n", true, ch, NULL, vict, TO_CHAR);
                    act("@RYou are burned by it!@n", true, ch, NULL, vict, TO_VICT);
                    act("@R$N@R is burned by it!@n", true, ch, NULL, vict, TO_NOTVICT);
                    SET_BIT_AR(AFF_FLAGS(vict), AFF_BURNED);
                    damage += damage * 0.4;
                }
            }
            ...
            int64_t amt3 = (((ch_getEffMaxPL(ch)) / 200) + GET_OBJ_WEIGHT(obj));
            int64_t result3;
            result3 = ch_decCurST(ch, amt3, 0);
            if (!GET_EQ(ch, WEAR_WIELD1) && !GET_EQ(ch, WEAR_WIELD2))
                perc += 12;
    ...
    if (tch) {
        ...
        if (((ch_getCurST(ch))) < (((ch_getEffMaxPL(ch)) / 100) + GET_PC_WEIGHT(tch))) {
            send_to_char(ch, "You do not have enough stamina to do it...\r\n");
            return;
        }
        ...
        if (grab == false) {
            act("@WYou try to grab @C$N@W and throw them, but they manage to dodge your attempt!@n", true, ch, NULL,
                tch, TO_CHAR);
            ...
            handle_cooldown(ch, 5);
            int64_t amt = ((ch_getEffMaxPL(ch)) / 200) + GET_PC_WEIGHT(tch);
            int64_t result;
            result = ch_decCurST(ch, amt, 0);
            return;
        } else {
            handle_cooldown(ch, 5);
            improve_skill(ch, SKILL_THROW, 0);
            damage = ((GET_PC_WEIGHT(tch) * GET_STR(ch)) * (GET_CHA(ch) / 3)) + ((ch_getEffMaxPL(ch)) / 100);
            damage += ROOM_GRAVITY(IN_ROOM(ch)) * (ROOM_GRAVITY(IN_ROOM(ch)) / 2);
            perc = init_skill(ch, SKILL_THROW);
            perc2 = init_skill(vict, SKILL_DODGE);
            ...
            if (perc - (perc2 / 10) < prob) {
                if (perc2 > 0) {
                    act("@WYou grab @C$N@W and spinning around quickly you throw $M!@n", true, ch, NULL, tch,
                        TO_CHAR);
                    act("@C$n@W grabs YOU and spinning around quickly $e throws you!@n", true, ch, NULL, tch,
                        TO_VICT);
                    act("@C$n@W grabs @c$N@W and spinning around quickly $e throws $M!@n", true, ch, NULL, tch,
                        TO_NOTVICT);
                ...
                int64_t amt = (((ch_getEffMaxPL(ch)) / 100) + GET_PC_WEIGHT(tch));
                int64_t result;
                result = ch_decCurST(ch, amt, 0);
                act("@W--@R$N@W--@n", true, ch, NULL, vict, TO_CHAR);
                act("@W--@R$N@W--@n", true, tch, NULL, vict, TO_CHAR);
                act("@W--@RYOU@W--@n", true, vict, NULL, NULL, TO_CHAR);
                hurt(0, 0, ch, vict, NULL, 0, 0);
                act("@W--@R$N@W--@n", true, ch, NULL, tch, TO_CHAR);
                act("@W--@R$N@W--@n", true, vict, NULL, tch, TO_CHAR);
                act("@W--@RYOU@W--@n", true, tch, NULL, NULL, TO_CHAR);
                hurt(0, 0, ch, tch, NULL, 0, 0);
                return;
            } else if (perc - (perc2 / 10) >= prob) {
                miss = false;
            ...
            if (miss == false) {
                act("@WYou grab @C$N@W and spinning around quickly you throw $M!@n", true, ch, NULL, tch, TO_CHAR);
                act("@C$n@W grabs YOU and spinning around quickly $e throws you!@n", true, ch, NULL, tch, TO_VICT);
                act("@C$n@W grabs @c$N@W and spinning around quickly $e throws $M!@n", true, ch, NULL, tch,
                    TO_NOTVICT);
                act("@WThrown through the air, YOU fly at @c$N@W and smash into $M!@n", true, tch, NULL, vict,
                    TO_CHAR);
                act("@WThrown through the air, @C$n@W flies at YOU and smashes into YOU!@n", true, tch, NULL, vict,
                    TO_VICT);
                act("@WThrown through the air, @C$n@W flies at @c$N@W and smashes into $M!@n", true, tch, NULL, vict,
                    TO_NOTVICT);
                act("@W--@R$N@W--@n", true, ch, NULL, vict, TO_CHAR);
                act("@W--@R$N@W--@n", true, tch, NULL, vict, TO_CHAR);
                act("@W--@RYOU@W--@n", true, vict, NULL, NULL, TO_CHAR);
            ...
            int64_t amt1 = (((ch_getEffMaxPL(ch)) / 200) + GET_PC_WEIGHT(tch));
            int64_t result1;
            result1 = ch_decCurST(ch, amt1, 0);
            WAIT_STATE(ch, PULSE_3SEC);
        }
...
ACMD(do_selfd) {
    ...
    if (!PLR_FLAGGED(ch, PLR_SELFD)) {
        ...
        if ((IS_MAJIN(ch) || IS_BIO(ch)) && ch_getCurLFPercent(ch) > 0.5) {
            int64_t result;
        ...
        dmg *= 1.5;
        int64_t result;
        result = ch_decCurHealthPercent(ch, 1, 1);
        GET_SUPP(ch) = 0;
        GET_SUPPRESS(ch) = 0;
        ...
        for (tch = world[IN_ROOM(ch)].people; tch; tch = next_v) {
            ...
            if (MOB_FLAGGED(tch, MOB_NOKILL)) {
                ...
                act("@r$N@R is caught in the explosion!@n", true, ch, NULL, tch, TO_CHAR);
                act("@RYou are caught in the explosion!@n", true, ch, NULL, tch, TO_VICT);
                act("@r$N@R is caught in the explosion!@n", true, ch, NULL, tch, TO_NOTVICT);
                hurt(0, 0, ch, tch, NULL, dmg, 1);
            }
        }
        if (PLR_FLAGGED(ch, PLR_IMMORTAL)) {
...
ACMD(do_razor) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (dge > rand_number(1, 130)) {
                    act("@C$N@W manages to dodge your Water Razor, letting it fly harmlessly by!@n", false, ch, NULL,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Water Razor, letting it fly harmlessly by!@n", false, ch, NULL, vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your Water Razor misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a Water Razor at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a Water Razor at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
            ...
            if (vict) {
                ...
                if ((!IS_NPC(vict) && !AFF_FLAGGED(vict, AFF_SPIRIT)) || (IS_NPC(vict) && GET_HIT(vict) > 0)) {
                    int64_t result1;
                    result1 = ch_decCurKI(vict, reduction, 0);
                    int64_t result;
                    result = ch_decCurST(vict, reduction, 0);
                }
            }
            return;
        }
    ...
    if (vict) {
        ...
        if (!tech_handle_zanzoken(ch, vict, "attack")) {
            ...
            if (GET_SKILL(ch, SKILL_WSPIKE) >= 100) {
                int64_t amt = (ch_getMaxKI(ch) * attperc) * .3;
                int64_t result;
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > rand_number(1, 130)) {
                    act("@C$N@W moves quickly and blocks your water spikes!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W water spikes!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W water spikes!@n", false, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_WSPIKE) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                    ...
                    act("@WYou can't believe it but your water spikes miss, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fire water spikes at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fire water spikes at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                    if (GET_SKILL_PERF(ch, SKILL_WSPIKE) == 3 && attperc > minimum) {
                        pcost(ch, attperc - 0.05, 0);
                    } else {
                ...
                act("@WYou can't believe it but your water spikes miss, flying through the air harmlessly!@n", false,
                    ch, NULL, vict, TO_CHAR);
                act("@C$n@W fires water spikes at you, but misses!@n", false, ch, NULL, vict, TO_VICT);
                act("@c$n@W fires water spikes at @C$N@W, but somehow misses!@n", false, ch, NULL, vict, TO_NOTVICT);
                if (GET_SKILL_PERF(ch, SKILL_WSPIKE) == 3 && attperc > minimum) {
                    pcost(ch, attperc - 0.05, 0);
                } else {
                    pcost(ch, attperc, 0);
        ...
        dmg = damtype(ch, 43, skill, attperc);
        dmg /= 10;
        act("@WYou fire water spikes at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires water spikes at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        if (GET_SKILL_PERF(ch, SKILL_WSPIKE) == 3) {
            WAIT_STATE(ch, PULSE_3SEC);
        }
        hurt(0, 0, ch, NULL, obj, dmg, 0);
...
ACMD(do_koteiru) {
    ...
    if (vict) {
            ...
            if (((ch_getCurST(vict))) > 0) {
                if (dge > rand_number(1, 130)) {
                    act("@C$N@W manages to dodge your Koteiru Bakuha, letting it fly harmlessly by!@n", false, ch,
                        NULL, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Koteiru Bakuha, letting it fly harmlessly by!@n", false, ch, NULL,
                        vict, TO_VICT);
                    ...
                    act("@WYou can't believe it but your Koteiru Bakuha misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a Koteiru Bakuha at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a Koteiru Bakuha at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
            ...
            if (vict) {
                if (GET_HIT(vict) > 1) {
                    if (rand_number(1, 4) == 1 && !AFF_FLAGGED(vict, AFF_FROZEN) && !IS_DEMON(vict)) {
                        act("@CYour body completely freezes!@n", true, vict, NULL, NULL, TO_CHAR);
                        act("@c$n's@C body completely freezes!@n", true, vict, NULL, NULL, TO_ROOM);
        ...
        dmg = damtype(ch, 48, skill, attperc);
        dmg /= 10;
        act("@WYou fire Koteiru Bakuha at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires Koteiru Bakuha at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    } else {
        send_to_char(ch, "Error! Please report.\r\n");
...
ACMD(do_hspiral) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (dge > rand_number(1, 130)) {
                    act("@C$N@W manages to dodge your Hell Spiral, letting it fly harmlessly by!@n", false, ch, NULL,
                        vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W Hell Spiral, letting it fly harmlessly by!@n", false, ch, NULL, vict,
                        TO_VICT);
                    ...
                    act("@WYou can't believe it but your Hell Spiral misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a Hell Spiral at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a Hell Spiral at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
        ...
        dmg = damtype(ch, 49, skill, attperc);
        dmg /= 10;
        act("@WYou fire Hell Spiral at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires Hell Spiral at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    } else {
        send_to_char(ch, "Error! Please report.\r\n");
...
ACMD(do_breaker) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if (((ch_getCurST(vict))) > 0) {
                if (blk > rand_number(1, 130)) {
                    act("@C$N@W moves quickly and blocks your Star Breaker!@n", false, ch, NULL, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W Star Breaker!@n", false, ch, NULL, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W Star Breaker!@n", false, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    dmg = damtype(ch, 10, skill, attperc);
                    dmg /= 4;
                    ...
                    act("@WYou can't believe it but your Star Breaker misses, flying through the air harmlessly!@n",
                        false, ch, NULL, vict, TO_CHAR);
                    act("@C$n@W fires a Star Breaker at you, but misses!@n ", false, ch, NULL, vict, TO_VICT);
                    act("@c$n@W fires a Star Breaker at @C$N@W, but somehow misses!@n ", false, ch, NULL, vict,
                        TO_NOTVICT);
                    pcost(ch, attperc, 0);
                    hurt(0, 0, ch, vict, NULL, 0, 1);
                    return;
        ...
        dmg = damtype(ch, 46, skill, attperc);
        dmg /= 10;
        act("@WYou fire Star Breaker at $p@W!@n", false, ch, obj, NULL, TO_CHAR);
        act("@C$n@W fires Star Breaker at $p@W!@n", false, ch, obj, NULL, TO_ROOM);
        hurt(0, 0, ch, NULL, obj, dmg, 0);
        pcost(ch, attperc, 0);
    } else {
        send_to_char(ch, "Error! Please report.\r\n");
