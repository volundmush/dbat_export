...
void dispel_ash(struct char_data *ch) {
    ...
    if (ash) {
        ...
        if (GET_OBJ_COST(ash) == 3) {
            if (GET_INT(ch) > roll) {
                act("@GYou clear the air with the shockwaves of your power!@n", true, ch, ash, NULL, TO_CHAR);
                act("@C$n@G clears the air with the shockwaves of $s power!@n", true, ch, ash, NULL, TO_ROOM);
                extract_obj(ash);
            }
    ...
    if (ch->followers) {
        for (k = ch->followers; k; k = next) {
            ...
            if (k->follower != ch) {
                ...
                if (count == 1) {
                    party1 = k->follower;
                    plperc1 = (GET_HIT(party1) * 100) / (ch_getEffMaxPL(party1));
                    ...
                    if (((ch_getCurST(party1))) >= GET_MAX_MOVE(party1)) {
                        stam1 = 7;
                    } else {
                        if (((ch_getCurST(party1))) >= GET_MAX_MOVE(party1) * .9) {
                            stam1 = 6;
                        } else if ((ch_getCurST(party1)) >= GET_MAX_MOVE(party1) * .8) {
                            stam1 = 5;
                        } else if ((ch_getCurST(party1)) >= GET_MAX_MOVE(party1) * .7) {
                            stam1 = 4;
                        } else if ((ch_getCurST(party1)) >= GET_MAX_MOVE(party1) * .5) {
                            stam1 = 3;
                        } else if ((ch_getCurST(party1)) >= GET_MAX_MOVE(party1) * .4) {
                            stam1 = 2;
                        } else if ((ch_getCurST(party1)) >= GET_MAX_MOVE(party1) * .2) {
                            stam1 = 1;
                        } else {
                            stam1 = 0;
                        }
                    ...
                    party2 = k->follower;
                    plperc2 = (GET_HIT(party2) * 100) / (ch_getEffMaxPL(party2));
                    ...
                    if (((ch_getCurST(party2))) >= GET_MAX_MOVE(party2)) {
                        stam2 = 7;
                    } else {
                        if (((ch_getCurST(party2))) >= GET_MAX_MOVE(party2) * .9) {
                            stam2 = 6;
                        } else if ((ch_getCurST(party2)) >= GET_MAX_MOVE(party2) * .8) {
                            stam2 = 5;
                        } else if ((ch_getCurST(party2)) >= GET_MAX_MOVE(party2) * .7) {
                            stam2 = 4;
                        } else if ((ch_getCurST(party2)) >= GET_MAX_MOVE(party2) * .5) {
                            stam2 = 3;
                        } else if ((ch_getCurST(party2)) >= GET_MAX_MOVE(party2) * .4) {
                            stam2 = 2;
                        } else if ((ch_getCurST(party2)) >= GET_MAX_MOVE(party2) * .2) {
                            stam2 = 1;
                        } else {
                            stam2 = 0;
                        }
                    ...
                    party3 = k->follower;
                    plperc3 = (GET_HIT(party3) * 100) / (ch_getEffMaxPL(party3));
                    ...
                    if (((ch_getCurST(party3))) >= GET_MAX_MOVE(party3)) {
                        stam3 = 7;
                    } else {
                        if (((ch_getCurST(party3))) >= GET_MAX_MOVE(party3) * .9) {
                            stam3 = 6;
                        } else if ((ch_getCurST(party3)) >= GET_MAX_MOVE(party3) * .8) {
                            stam3 = 5;
                        } else if ((ch_getCurST(party3)) >= GET_MAX_MOVE(party3) * .7) {
                            stam3 = 4;
                        } else if ((ch_getCurST(party3)) >= GET_MAX_MOVE(party3) * .5) {
                            stam3 = 3;
                        } else if ((ch_getCurST(party3)) >= GET_MAX_MOVE(party3) * .4) {
                            stam3 = 2;
                        } else if ((ch_getCurST(party3)) >= GET_MAX_MOVE(party3) * .2) {
                            stam3 = 1;
                        } else {
                            stam3 = 0;
                        }
                    ...
                    party4 = k->follower;
                    plperc4 = (GET_HIT(party4) * 100) / (ch_getEffMaxPL(party4));
                    ...
                    if (((ch_getCurST(party4))) >= GET_MAX_MOVE(party4)) {
                        stam4 = 7;
                    } else {
                        if (((ch_getCurST(party4))) >= GET_MAX_MOVE(party4) * .9) {
                            stam4 = 6;
                        } else if ((ch_getCurST(party4)) >= GET_MAX_MOVE(party4) * .8) {
                            stam4 = 5;
                        } else if ((ch_getCurST(party4)) >= GET_MAX_MOVE(party4) * .7) {
                            stam4 = 4;
                        } else if ((ch_getCurST(party4)) >= GET_MAX_MOVE(party4) * .5) {
                            stam4 = 3;
                        } else if ((ch_getCurST(party4)) >= GET_MAX_MOVE(party4) * .4) {
                            stam4 = 2;
                        } else if ((ch_getCurST(party4)) >= GET_MAX_MOVE(party4) * .2) {
                            stam4 = 1;
                        } else {
                            stam4 = 0;
                        }
...
int64_t physical_cost(struct char_data *ch, int skill) {
    ...
    if (skill == SKILL_PUNCH)
        result = (ch_getEffMaxPL(ch)) / 500;
    else if (skill == SKILL_KICK)
        result = (ch_getEffMaxPL(ch)) / 350;
    else if (skill == SKILL_ELBOW)
        result = (ch_getEffMaxPL(ch)) / 400;
    else if (skill == SKILL_KNEE)
        result = (ch_getEffMaxPL(ch)) / 300;
    else if (skill == SKILL_UPPERCUT)
        result = (ch_getEffMaxPL(ch)) / 200;
    else if (skill == SKILL_ROUNDHOUSE)
        result = (ch_getEffMaxPL(ch)) / 150;
    else if (skill == SKILL_HEELDROP)
        result = (ch_getEffMaxPL(ch)) / 80;
    else if (skill == SKILL_SLAM)
        result = (ch_getEffMaxPL(ch)) / 90;
...
int roll_pursue(struct char_data *ch, struct char_data *vict) {
    ...
    if (skill > perc) {
        ...
        act("@C$n@R pursues after the fleeing @c$N@R!@n", true, ch, NULL, vict, TO_NOTVICT);
        char_from_room(ch);
        char_to_room(ch, IN_ROOM(vict));
        act("@GYou pursue right after @c$N@G!@n", true, ch, NULL, vict, TO_CHAR);
        act("@C$n@R pursues after you!@n", true, ch, NULL, vict, TO_VICT);
        act("@C$n@R pursues after the fleeing @c$N@R!@n", true, ch, NULL, vict, TO_NOTVICT);
        ...
        if (ch->followers) {
            for (k = ch->followers; k; k = next) {
                ...
                if ((GET_ROOM_VNUM(IN_ROOM(k->follower)) == inroom) && (GET_POS(k->follower) >= POS_STANDING) &&
                    ...
                    act("You follow $N.", true, k->follower, NULL, ch, TO_CHAR);
                    act("$n follows after $N.", true, k->follower, NULL, ch, TO_NOTVICT);
                    act("$n follows after you.", true, k->follower, NULL, ch, TO_VICT);
...
char *sense_location(struct char_data *ch) {
    ...
    char *message = calloc(MAX_INPUT_LENGTH, sizeof(char));
    room_rnum roomnum = GET_ROOM_VNUM(IN_ROOM(ch)), num = 0;
...
void reveal_hiding(struct char_data *ch, int type) {
    ...
    if (type == 0) { /* Automatic reveal. */
        act("@MYou feel as though what you just did may have revealed your hiding spot...@n", true, ch, NULL,
            NULL, TO_CHAR);
        act("@M$n moves a little and you notice them!@n", true, ch, NULL, NULL, TO_ROOM);
        ...
        for (d = descriptor_list; d; d = d->next) {
            ...
            if (GET_SKILL(tch, SKILL_SPOT) + rand1 >= GET_SKILL(ch, SKILL_HIDE) + rand2) {
                REMOVE_BIT_AR(AFF_FLAGS(ch), AFF_HIDE);
                act("@M$N seems to notice you!@n", true, ch, NULL, tch, TO_CHAR);
                act("@MYou notice $n's movements reveal $s hiding spot!@n", true, ch, NULL, tch, TO_VICT);
        ...
        act("@MThe scouter makes some beeping sounds as you tinker with its buttons.@n", true, ch, NULL, NULL,
            TO_CHAR);
        for (d = descriptor_list; d; d = d->next) {
            if (STATE(d) != CON_PLAYING)
                continue;
            ...
            if (GET_SKILL(tch, SKILL_LISTEN) > axion_dice(0)) {
                switch (type) {
                    case 3:
                        act("@MYou notice some beeping sounds that sound really close by.@n", true, ch, NULL, tch,
                            TO_VICT);
                        break;
                    default:
    ...
    if (GET_SPEEDI(ch) < GET_SPEEDI(blocker) && GET_POS(blocker) > POS_SITTING) {
        if (!AFF_FLAGGED(blocker, AFF_BLIND) && !PLR_FLAGGED(blocker, PLR_EYEC)) {
            ...
            if (!GET_SKILL(ch, SKILL_ESCAPE_ARTIST) || (GET_SKILL(ch, SKILL_ESCAPE_ARTIST) &&
                ...
                act("$n tries to leave, but can't outrun $N!", true, ch, NULL, blocker, TO_NOTVICT);
                act("$n tries to leave, but can't outrun you!", true, ch, NULL, blocker, TO_VICT);
                act("You try to leave, but can't outrun $N!", true, ch, NULL, blocker, TO_CHAR);
                ...
                act("$n proves $s great skill and escapes from $N's attempted block!", true, ch, NULL, blocker,
                    TO_NOTVICT);
                act("$n proves $s great skill and escapes from your attempted block!", true, ch, NULL, blocker,
                    TO_VICT);
                act("Using your great skill you manage to escape from $N's attempted block!", true, ch, NULL,
                    blocker, TO_CHAR);
                BLOCKED(ch) = NULL;
                BLOCKS(blocker) = NULL;
            }
            ...
            act("$n proves $s great skill and escapes from $N's attempted block!", true, ch, NULL, blocker,
                TO_NOTVICT);
            act("$n proves $s great skill and escapes from your attempted block!", true, ch, NULL, blocker, TO_VICT);
            act("Using your great skill you manage to escape from $N's attempted block!", true, ch, NULL, blocker,
                TO_CHAR);
            BLOCKED(ch) = NULL;
            BLOCKS(blocker) = NULL;
        }
    } else if (GET_POS(blocker) <= POS_SITTING) {
        act("$n proves $s great skill and escapes from $N!", true, ch, NULL, blocker, TO_NOTVICT);
        act("$n proves $s great skill and escapes from you!", true, ch, NULL, blocker, TO_VICT);
        act("Using your great skill you manage to escape from $N!", true, ch, NULL, blocker, TO_CHAR);
        BLOCKED(ch) = NULL;
        BLOCKS(blocker) = NULL;
    } else if (GET_POS(blocker) > POS_SITTING) {
        act("$n proves $s great skill and escapes from $N's attempted block!", true, ch, NULL, blocker, TO_NOTVICT);
        act("$n proves $s great skill and escapes from your attempted block!", true, ch, NULL, blocker, TO_VICT);
        act("Using your great skill you manage to escape from $N's attempted block!", true, ch, NULL, blocker,
            TO_CHAR);
        BLOCKED(ch) = NULL;
...
int64_t molt_threshold(struct char_data *ch) {
    ...
    if (!IS_ARLIAN(ch))
        ...
        threshold = (((GET_MOLT_LEVEL(ch) + 1) * (ch_getBasePL(ch) * 0.02)) * GET_CON(ch)) / 4;
        threshold = threshold * 0.25;
    } else if (GET_MOLT_LEVEL(ch) < 200) {
        threshold = (((GET_MOLT_LEVEL(ch) + 1) * (ch_getBasePL(ch) * 0.02)) * GET_CON(ch)) / 2;
        threshold = threshold * 0.20;
    } else if (GET_MOLT_LEVEL(ch) < 400) {
        threshold = (((GET_MOLT_LEVEL(ch) + 1) * (ch_getBasePL(ch) * 0.02)) * GET_CON(ch));
...
void handle_evolution(struct char_data *ch, int64_t dmg) {
    ...
    if (GET_MOLT_EXP(ch) > molt_threshold(ch)) {
        if (GET_MOLT_LEVEL(ch) <= GET_LEVEL(ch) * 2 || GET_LEVEL(ch) >= 100) {
            ...
            int armorgain = 0;
            int64_t plgain = ch_getBasePL(ch) * rand1, stamgain = ch_getBaseST(ch) * rand2;
            armorgain = armor_evolve(ch);
            int64_t result1;
            result1 = ch_gainBasePL(ch, plgain, false);
            int64_t result;
            result = ch_gainBaseST(ch, stamgain, false);
...
void demon_refill_lf(struct char_data *ch, int64_t num) {
    ...
    for (tch = world[IN_ROOM(ch)].people; tch; tch = tch->next_in_room) {
        if (!IS_DEMON(tch))
            continue;
        if (((ch_getCurLF(tch))) >= ((ch_getMaxLF(tch))))
            continue;
        else {
            int64_t result;
            result = ch_incCurLF(tch, num, true);
        ...
        if (!IS_NPC(ch) && IS_NPC(vict)) {
            if ((strstr(speech, "hello") || strstr(speech, "greet") || strstr(speech, "Hello") ||
                ...
                if (IS_HUMAN(vict) || IS_HALFBREED(vict)) {
                    switch (rand_number(1, 4)) {
                        case 1:
                            act("@w$n@W says, '@CYes, hello to you as well $N.@W'@n", true, vict, NULL, ch, TO_ROOM);
                            break;
                        case 2:
                            act("@w$n@W says, '@CHello!@W'@n", true, vict, NULL, ch, TO_ROOM);
                            break;
                        case 3:
                            act("@w$n@W says, '@CHi, $N, how are you doing?@W'@n", true, vict, NULL, ch, TO_ROOM);
                            break;
                        case 4:
                            act("@w$n@W says, '@CGreetings, $N. What are you up to?@W'@n", true, vict, NULL, ch,
                                TO_ROOM);
                            break;
                    }
                } /* End Human Section */
                    ...
                    switch (rand_number(1, 4)) {
                        case 1:
                            act("@w$n@W says, '@CHmph, hi.@W'@n", true, vict, NULL, ch, TO_ROOM);
                            break;
                        case 2:
                            act("@w$n@W says, '@CHello weakling.@W'@n", true, vict, NULL, ch, TO_ROOM);
                            break;
                        case 3:
                            ...
                            break;
                        case 4:
                            act("@w$n@W says, '@C$N, you are not welcome around me.@W'@n", true, vict, NULL, ch,
                                TO_ROOM);
                            break;
                    }
                } /* End Saiyan Section */
                    ...
                    switch (rand_number(1, 4)) {
                        case 1:
                            act("@w$n@W says, '@CHa ha... Yes, hello.@W'@n", true, vict, NULL, ch, TO_ROOM);
                            break;
                        case 2:
                            act("@w$n@W says, '@CAh a polite greeting. It's good to know your kind isn't totally worthless.@W'@n",
                                true, vict, NULL, ch, TO_ROOM);
                            break;
                        case 3:
                            act("@w$n@W says, '@C$N, hello. Now leave me be.@W'@n", true, vict, NULL, ch, TO_ROOM);
                            break;
                        case 4:
                            act("@w$n@W says, '@C$N, you are below me. Now begone.@W'@n", true, vict, NULL, ch,
                                TO_ROOM);
                            break;
                    }
                } /* End Icer Section */
                    ...
                    switch (rand_number(1, 4)) {
                        case 1:
                            act("@w$n@W says, '@CGreetings, $N, may your travels be well.@W'@n", true, vict, NULL,
                                ch, TO_ROOM);
                            break;
                        case 2:
                            act("@w$n@W says, '@CHello.@W'@n", true, vict, NULL, ch, TO_ROOM);
                            break;
                        case 3:
                            act("@w$n@W says, '@C$N, hello.@W'@n", true, vict, NULL, ch, TO_ROOM);
                            break;
                        case 4:
                            act("@w$n@W says, '@C$N, it is nice to meet you.@W'@n", true, vict, NULL, ch, TO_ROOM);
                            break;
                    }
                } /* End Konatsu Section */
                    ...
                    switch (rand_number(1, 4)) {
                        case 1:
                            ...
                            break;
                        case 2:
                            act("@w$n@W says, '@CA peaceful greeting to you, $N.@W'@n", true, vict, NULL, ch,
                                TO_ROOM);
                            break;
                        case 3:
                            act("@w$n@W says, '@C$N, hello. What is your business here?@W'@n", true, vict, NULL, ch,
                                TO_ROOM);
                            break;
                        case 4:
                            act("@w$n@W says, '@C$N, greetings.@W'@n", true, vict, NULL, ch, TO_ROOM);
                            break;
                    }
                } /* End Namek Section */
                    ...
                    switch (rand_number(1, 4)) {
                        case 1:
                            act("@w$n@W says, '@CPeace, stranger.@W'@n", true, vict, NULL, ch, TO_ROOM);
                            break;
                        case 2:
                            act("@w$n@W says, '@CStay out of my way.@W'@n", true, vict, NULL, ch, TO_ROOM);
                            break;
                        case 3:
                            act("@w$n@W says, '@C$N, what is your business here?@W'@n", true, vict, NULL, ch,
                                TO_ROOM);
                            break;
                        case 4:
                            act("@w$n@W says, '@C...Hello.@W'@n", true, vict, NULL, ch, TO_ROOM);
                            break;
                    }
                } /* End Arlian Section */
                else if (IS_ANDROID(vict)) {
                    act("@w$n@W says, '@C...@W'@n", true, vict, NULL, ch, TO_ROOM);
                } /* End Android Section */
                else if (IS_MAJIN(vict)) {
                    switch (rand_number(1, 2)) {
                        case 1:
                            act("@w$n@W says, '@CHa ha...@W'@n", true, vict, NULL, ch, TO_ROOM);
                            break;
                        case 2:
                            act("@w$n@W says, '@CHello. What candy you want to be?@W'@n", true, vict, NULL, ch,
                                TO_ROOM);
                            break;
                    }
                } /* End MAJIN Section */
                    ...
                    switch (rand_number(1, 3)) {
                        case 1:
                            if (IS_SAIYAN(ch)) {
                                act("@w$n@W says, '@CEwww, dirty monkey...@W'@n", true, vict, NULL, ch, TO_ROOM);
                            } else {
                                act("@w$n@W says, '@CHello.@W'@n", true, vict, NULL, ch, TO_ROOM);
                            }
                            break;
                        ...
                        case 3:
                            if (IS_SAIYAN(ch)) {
                                ...
                                act("@w$n@W says, '@C$N, hello. What's your IQ?@W'@n", true, vict, NULL, ch,
                                    TO_ROOM);
                            }
                            break;
                    }
                    ...
                    act("Hmph, yeah hi.", true, vict, NULL, ch, TO_ROOM);
                }
            } /* End Hello Section */
            ...
            if ((strstr(speech, "spar") || strstr(speech, "Spar")) && !FIGHTING(vict)) {
                ...
                if (GET_LEVEL(vict) > 4 && GET_ALIGNMENT(vict) >= 0) {
                    ...
                    if (vict->original == ch) {
                        act("@w$n@W says, '@C$N, sure. I'll spar with you.@W'@n", true, vict, NULL, ch, TO_ROOM);
                        SET_BIT_AR(MOB_FLAGS(vict), MOB_SPAR);
                        return 0;
                    }
                    if (remember == true) {
                        act("@w$n@W says, '@C$N you will die by my hand!@W'@n", true, vict, NULL, ch, TO_ROOM);
                        return 1;
                    } else if (MOB_FLAGGED(vict, MOB_NOKILL)) {
                        act("@w$n@W says, '@C$N, I have no need to spar with you.@W'@n", true, vict, NULL, ch,
                            TO_ROOM);
                        return 1;
                    } else if (MOB_FLAGGED(vict, MOB_AGGRESSIVE)) {
                        act("@w$n@W says, '@C$N, I will kill you instead.@W'@n", true, vict, NULL, ch, TO_ROOM);
                        return 1;
                    } else if (MOB_FLAGGED(vict, MOB_DUMMY)) {
                        act("@w$n@W says, '@C...@W'@n", true, vict, NULL, ch, TO_ROOM);
                        return 1;
                    } else if ((ch_getEffMaxPL(ch)) > (ch_getEffMaxPL(vict)) * 2) {
                        act("@w$n@W says, '@C$N, no way will I spar. I already know I would lose badly.@W'@n", true,
                            vict, NULL, ch, TO_ROOM);
                        return 1;
                    } else if ((ch_getEffMaxPL(vict)) > (ch_getEffMaxPL(ch)) * 2) {
                        act("@w$n@W says, '@C$N, you wouldn't last very long.@W'@n", true, vict, NULL, ch, TO_ROOM);
                        return 1;
                    } else if (GET_HIT(vict) < (ch_getEffMaxPL(vict)) * .8) {
                        act("@w$n@W says, '@C$N, I need to recover first.@W'@n", true, vict, NULL, ch, TO_ROOM);
                        return 1;
                    } else if (rand_number(1, 50) >= 40 && !MOB_FLAGGED(vict, MOB_SPAR)) {
                        act("@w$n@W says, '@C$N, maybe in a bit.@W'@n", true, vict, NULL, ch, TO_ROOM);
                        return 1;
                    } else {
                    ...
                    act("@w$n@W says, '@CSpar? I don't play games, I play for blood...@W'@n", true, vict, NULL, ch,
                        TO_ROOM);
                    return 1;
                } else {
                    act("@w$n@W says, '@CSpar? I prefer not to thank you...@W'@n", true, vict, NULL, ch, TO_ROOM);
                    return 1;
                }
            ...
            if (strstr(speech, "goodbye") || strstr(speech, "Goodbye") || strstr(speech, "bye") ||
                ...
                if (GET_ALIGNMENT(vict) >= 0) {
                    if (GET_SEX(vict) == SEX_MALE) {
                        if (GET_SEX(ch) == SEX_FEMALE) {
                            act("@w$n@W says, '@C$N, goodbye babe.@W'@n", true, vict, NULL, ch, TO_ROOM);
                        } else {
                            act("@w$n@W says, '@C$N, goodbye.@W'@n", true, vict, NULL, ch, TO_ROOM);
                        }
                    } else if (GET_SEX(vict) == SEX_FEMALE) {
                        if (GET_SEX(ch) == SEX_MALE) {
                            act("@w$n@W says, '@C$N, goodbye...@W'@n", true, vict, NULL, ch, TO_ROOM);
                        } else {
                            act("@w$n@W says, '@C$N, bye.@W'@n", true, vict, NULL, ch, TO_ROOM);
                        }
                    } else {
                        act("@w$n@W says, '@C$N, goodbye.@W'@n", true, vict, NULL, ch, TO_ROOM);
                    }
                ...
                if (GET_ALIGNMENT(vict) < 0) {
                    if (GET_SEX(vict) == SEX_MALE) {
                        if (GET_SEX(ch) == SEX_FEMALE) {
                            act("@w$n@W says, '@CGoodbye. Eh heh heh.@W'@n", true, vict, NULL, ch, TO_ROOM);
                        } else {
                            act("@w$n@W says, '@CSo long and good ridance.@W'@n", true, vict, NULL, ch, TO_ROOM);
                        }
                    } else if (GET_SEX(vict) == SEX_FEMALE) {
                        if (GET_SEX(ch) == SEX_MALE) {
                            act("@w$n@W says, '@CGoodbye then...@W'@n", true, vict, NULL, ch, TO_ROOM);
                        } else {
                            act("@w$n@W says, '@C$N, no one wanted you around anyway.@W'@n", true, vict, NULL, ch,
                                TO_ROOM);
                        }
                    } else {
                        act("@w$n@W says, '@CFine get lost.@W'@n", true, vict, NULL, ch, TO_ROOM);
                    }
                }
            } /* End goodbye If */
            if (strstr(speech, "train") || strstr(speech, "Train") || strstr(speech, "exercise") ||
                ...
                if (GET_ALIGNMENT(vict) >= 0 && !MOB_FLAGGED(vict, MOB_NOKILL)) {
                    ...
                    if (GET_LEVEL(vict) >= 10 && GET_LEVEL(vict) < 30) {
                        act("@w$n@W says, '@CI think I might need a little more training...@W'@n", true, vict, NULL,
                            ch, TO_ROOM);
                    }
                    ...
                    if (GET_LEVEL(vict) >= 60) {
                        act("@w$n@W says, '@CI'm on top of my game.@W'@n", true, vict, NULL, ch, TO_ROOM);
                    }
                    if (GET_LEVEL(vict) < 5) {
                        act("@w$n@W says, '@CI really need to bust ass and train.@W'@n", true, vict, NULL, ch,
                            TO_ROOM);
                    }
                }
                if (GET_ALIGNMENT(vict) < 0 && !MOB_FLAGGED(vict, MOB_NOKILL)) {
                    if (GET_LEVEL(vict) > 4 && GET_LEVEL(vict) < 10) {
                        act("@w$n@W says, '@CWell maybe I could use some more training.@W'@n", true, vict, NULL, ch,
                            TO_ROOM);
                    }
                    if (GET_LEVEL(vict) >= 10 && GET_LEVEL(vict) < 30) {
                    ...
                    if (GET_LEVEL(vict) >= 30 && GET_LEVEL(vict) < 60) {
                        act("@w$n@W says, '@CTrain? I don't need to train to take you!@W'@n", true, vict, NULL, ch,
                            TO_ROOM);
                    }
                    if (GET_LEVEL(vict) >= 60) {
...
double speednar(struct char_data *ch) {
    ...
    if (((ch_getCurCarriedWeight(ch))) >= CAN_CARRY_W(ch)) {
        result = 1.0;
    } else {
        if (((ch_getCurCarriedWeight(ch))) >= CAN_CARRY_W(ch) * 0.95) {
            result = 0.95;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.9) {
            result = 0.90;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.85) {
            result = 0.85;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.80) {
            result = 0.80;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.75) {
            result = 0.75;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.70) {
            result = 0.70;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.65) {
            result = 0.65;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.60) {
            result = 0.60;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.55) {
            result = 0.55;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.50) {
            result = 0.50;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.45) {
            result = 0.45;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.40) {
            result = 0.40;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.35) {
            result = 0.35;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.30) {
            result = 0.30;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.25) {
            result = 0.25;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.20) {
            result = 0.20;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.15) {
            result = 0.15;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.10) {
            result = 0.10;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.05) {
            result = 0.05;
        } else if ((ch_getCurCarriedWeight(ch)) >= CAN_CARRY_W(ch) * 0.01) {
            result = 0.01;
        }
    }
    ...
    for (obj = world[IN_ROOM(ch)].contents; obj; obj = next_obj) {
        ...
        if (GET_OBJ_VNUM(obj) == 80 || GET_OBJ_VNUM(obj) == 81) {
            if (TARGET(obj) == ch || USER(obj) == ch) {
                act("$p @wloses its target and flies off into the distance.@n", true, NULL, obj, NULL, TO_ROOM);
                extract_obj(obj);
                continue;
            }
        }
...
struct time_info_data *age(struct char_data *ch) {
    ...
    player_age = *mud_time_passed(time(NULL), ch->time.birth);
...
void add_follower(struct char_data *ch, struct char_data *leader) {
    ...
    if (IN_ROOM(ch) != NOWHERE && IN_ROOM(leader) != NOWHERE && CAN_SEE(leader, ch)) {
        ...
        act("\r\n$n starts to follow $N.", true, ch, NULL, leader, TO_NOTVICT);
    }
}
...
int xdir_scan(char *dir_name, struct xap_dir *xapdirp) {
    xapdirp->total = scandir(dir_name, &(xapdirp->namelist), NULL, alphasort);
    xapdirp->current = 0;
...
bool IS_SET_AR(const bitvector_t field[], int bit) {
    return field[Q_FIELD(bit)] & Q_BIT(bit);
}

bool SET_BIT_AR(bitvector_t field[], int bit) {
    return field[Q_FIELD(bit)] |= Q_BIT(bit);
}

bool REMOVE_BIT_AR(bitvector_t field[], int bit) {
    return field[Q_FIELD(bit)] &= ~Q_BIT(bit);
}

bool TOGGLE_BIT_AR(bitvector_t field[], int bit) {
    return field[Q_FIELD(bit)] = field[Q_FIELD(bit)] ^ Q_BIT(bit);
}
...
bool IS_MOB(struct char_data *ch) {
    return IS_NPC(ch) && GET_MOB_RNUM(ch) <= top_of_mobt && GET_MOB_RNUM(ch) != NOBODY;
}
...
bool ROOM_FLAGGED(room_rnum loc, int flag) {
    return IS_SET_AR(ROOM_FLAGS(loc), flag);
}

bool DEAD(struct char_data *ch) {
    return PLR_FLAGGED(ch, PLR_NOTDEADYET) || MOB_FLAGGED(ch, MOB_NOTDEADYET);
}

int SECT(room_rnum room) {
    return VALID_ROOM_RNUM(room) ? world[room].sector_type : SECT_INSIDE;
}
...
room_vnum GET_ROOM_VNUM(room_rnum rnum) {
    return (room_vnum)(VALID_ROOM_RNUM(rnum) ? world[(rnum)].number : NOWHERE);
}

bool PLANET_ZENITH(room_rnum room) {
    return (GET_ROOM_VNUM(room) >= 3400 && GET_ROOM_VNUM(room) <= 3599) || (GET_ROOM_VNUM(room) >= 62900 && GET_ROOM_VNUM(room) <= 62999) || \
				(GET_ROOM_VNUM(room) == 19600);
}

const char* GET_NAME(struct char_data *ch) {
    return IS_NPC(ch) ? ch->short_descr : GET_PC_NAME(ch);
}

const char* GET_TITLE(struct char_data *ch) {
    return (ch)->desc ? (ch->desc->title ? ch->desc->title : "[Unset Title]") : "@D[@GNew User@D]";
}

const char* GET_USER(struct char_data *ch) {
...
int GET_CLASS_RANKS(struct char_data *ch, int whichclass) {
    return GET_CLASS_NONEPIC(ch, whichclass) + GET_CLASS_EPIC(ch, whichclass);
}

uint8_t GET_PC_HEIGHT(struct char_data *ch) {
...
uint8_t GET_PC_WEIGHT(struct char_data *ch) {
...
mob_vnum GET_MOB_VNUM(struct char_data *mob) {
    return IS_MOB(mob) ? mob_index[GET_MOB_RNUM(mob)].vnum : NOBODY;
}
...
bool IS_LAWFUL(struct char_data *ch) {
    return GET_ETHIC_ALIGNMENT(ch) >= 350;
}
...
uint8_t ALIGN_TYPE(struct char_data *ch) {
    return (IS_GOOD(ch) ? 0 : (IS_EVIL(ch) ? 6 : 3)) + \
...
bool IS_INMENU(struct descriptor_data *d) {
    switch(STATE(d)) {
        case CON_MENU:
        case CON_EXDESC:
        case CON_UMENU:
...
bool VALID_OBJ_RNUM(struct obj_data *obj) {
    return GET_OBJ_RNUM(obj) <= top_of_objt && GET_OBJ_RNUM(obj) != NOTHING;
}

obj_vnum GET_OBJ_VNUM(struct obj_data *obj) {
    return VALID_OBJ_RNUM(obj) ? obj_index[GET_OBJ_RNUM(obj)].vnum : NOTHING;
}
...
bool CAN_WEAR(struct obj_data *obj, int part) {
    return OBJWEAR_FLAGGED(obj, part);
}

const char* HSHR(struct char_data *ch) {
    return GET_SEX(ch) ? (GET_SEX(ch)==SEX_MALE ? "his":"her") :"its";
}

const char* HSSH(struct char_data *ch) {
    return GET_SEX(ch) ? (GET_SEX(ch)==SEX_MALE ? "he" :"she") : "it";
}

const char* HMHR(struct char_data *ch) {
    return GET_SEX(ch) ? (GET_SEX(ch)==SEX_MALE ? "him":"her") : "it";
}

const char* MAFE(struct char_data *ch) {
    return GET_SEX(ch) ? (GET_SEX(ch)==SEX_MALE ? "male":"female") : "questionably gendered";
}

const char* ANA(struct obj_data *obj) {
    return strchr("aeiouAEIOU", *(obj->name)) ? "An" : "A";
}

const char* SANA(struct obj_data *obj) {
    return strchr("aeiouAEIOU", *(obj->name)) ? "an" : "a";
}

bool LIGHT_OK(struct char_data *sub) {
    return !AFF_FLAGGED(sub, AFF_BLIND) && !PLR_FLAGGED(sub, PLR_EYEC) && \
...
bool CAN_SEE(struct char_data *sub, struct char_data *obj) {
   ...
   IMM_CAN_SEE(sub, obj) && (!AFF_FLAGGED(obj, 20) || GET_ADMLEVEL(sub) > 0));
}
...
bool DISG(struct char_data *ch, struct char_data *vict) {
    return PLR_FLAGGED(ch, PLR_DISGUISED) && (GET_ADMLEVEL(vict) > 0 || IS_NPC(vict));
}
...
bool CAN_GO(struct char_data *ch, int door) {
    return EXIT(ch,door) && \
...
bool IS_HUMANOID(struct char_data *ch) {
    return !IS_SERPENT(ch) && !IS_ANIMAL(ch);
}

bool RESTRICTED_RACE(struct char_data *ch) {
    return IS_MAJIN(ch) || IS_SAIYAN(ch) || IS_BIO(ch) || IS_HOSHIJIN(ch);
}

bool CHEAP_RACE(struct char_data *ch) {
    return IS_TRUFFLE(ch) || IS_MUTANT(ch) || IS_KONATSU(ch) || IS_DEMON(ch) || IS_KANASSAN(ch);
}
...
bool IS_NONPTRANS(struct char_data *ch) {
    return IS_HUMAN(ch) || ((IS_SAIYAN(ch) || IS_HALFBREED(ch)) && !IS_FULLPSSJ(ch) && !PLR_FLAGGED(ch, PLR_LSSJ) && !PLR_FLAGGED(ch, PLR_OOZARU)) ||\
...
bool IS_FULLPSSJ(struct char_data *ch) {
    return (IS_SAIYAN(ch) && PLR_FLAGGED(ch, PLR_FPSSJ) && PLR_FLAGGED(ch, PLR_TRANS1)) ||\
...
bool IS_NEUTER(struct char_data *ch) {
    return !IS_MALE(ch) && !IS_FEMALE(ch);
}
...
bool DIRT_ROOM(struct char_data *ch) {
    return OUTSIDE_SECTTYPE(ch) && ((SECT(IN_ROOM(ch)) != SECT_WATER_NOSWIM) && \
