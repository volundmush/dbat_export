...
void news_string_cleanup(struct descriptor_data *d, int terminator) {
    ...
    switch (terminator) {
        ...
        case STRINGADD_ABORT:
            ...
            act("$n stops editing the news.", true, d->character, NULL, NULL, TO_ROOM);
            break;
        default:
...
void tedit_string_cleanup(struct descriptor_data *d, int terminator) {
    ...
    switch (terminator) {
        ...
        case STRINGADD_ABORT:
            write_to_output(d, "Edit aborted.\r\n");
            act("$n stops editing some scrolls.", true, d->character, NULL, NULL, TO_ROOM);
            break;
        default:
...
ACMD(do_tedit) {
    ...
    act("$n begins editing a text file.", true, ch, NULL, NULL, TO_ROOM);
